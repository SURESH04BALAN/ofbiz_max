...
import static org.ofbiz.widget.screen.ScreenXmlViewHandler.module;
    ...
    public void render(String name, String page, String info, String contentType, String encoding, HttpServletRequest request, HttpServletResponse response) throws ViewHandlerException {
        ...
        try {
            ...
            writer.flush();
             ...
             try {
                throw new Exception("ScreenXmlViewRender: " + module + " page " +page + " context: " + screens.getContext());
            } catch (Exception ex) {
                Logger.getLogger(ScreenWidgetViewHandler.class.getName()).log(Level.SEVERE, null, ex);
            }
        } catch (IOException e) {
