...
Debug.logInfo("view: " + view, module);
        ...
        Debug.logInfo("paramMap: " + paramMap.toString(), module);
        ...
        Debug.logInfo("viewMap: " + viewMap.toString(), module);
        String nextPage;
        ...
        try {
            ...
            ViewHandler vh = viewFactory.getViewHandler(viewMap.type);
                    Debug.logInfo("ViewHandler: " + vh.getName(), module);
                     Debug.logInfo("ViewHandler: " + vh.toString(), module);
