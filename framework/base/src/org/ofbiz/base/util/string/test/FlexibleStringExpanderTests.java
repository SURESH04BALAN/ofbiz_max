...
public class FlexibleStringExpanderTests extends TestCase {
    ...
    private void everythingTest() {
        ...
        fseTest("plain-currency(AUD)", "${amount?currency(${usd})}", testMap, null, localeToTest, "$1,234,567.89", false);
        fseTest("currency(AUD)", "The total is ${amount?currency(${usd})}.", testMap, null, localeToTest, "The total is $1,234,567.89.", false);
        fseTest("currency(AUD): null", "The total is ${testMap.missing?currency(${usd})}.", testMap, null, localeToTest, "The total is .", false);
        fseTest("currency(AUD): missing", "The total is ${noList[0]?currency(${usd})}.", testMap, null, localeToTest, "The total is .", false);
        fseTest("currency(AUD): exception", "The total is ${throwException.value?currency(${usd})}.", testMap, null, localeToTest, "The total is .", false);
