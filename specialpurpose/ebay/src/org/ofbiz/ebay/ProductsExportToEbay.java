            ...
            try {
                ...
                if (listingFormat.equals("FixedPriceItem")) {
                    ...
                    if (UtilValidate.isEmpty(startPriceCurrencyUomId)) {
                        startPriceCurrencyUomId = EntityUtilProperties.getPropertyValue("general.properties", "currency.uom.id.default", "AUD", delegator);
                    }
                    ...
                    if (UtilValidate.isEmpty(buyItNowCurrencyUomId)) {
                        buyItNowCurrencyUomId = EntityUtilProperties.getPropertyValue("general.properties", "currency.uom.id.default", "AUD", delegator);
                    }
    ...
    */
    ...
    private static Map<String, Object> buildAddTransactionConfirmationItemRequest(Map<String, Object> context, StringBuffer dataItemsXml, String token, String itemId) {
        ...
        try {
            ...
            negotiatePriceElem.setAttribute("currencyID", "AUD");
