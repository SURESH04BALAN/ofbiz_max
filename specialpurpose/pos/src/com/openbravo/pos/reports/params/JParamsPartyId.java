...
public class JParamsPartyId extends ParamReportEditor {
         public String getEditorClassName(){
        return "JParamsPartyId";
    }
    /** Creates new form JParamsClosedPos */
    org.ofbiz.ordermax.base.components.PartyPickerEditPanel partyPickerEditPanel = null;
    final String labelText ;
    public JParamsPartyId(String labelText) {
        this.labelText = labelText;
        initComponents();
        partyPickerEditPanel = new org.ofbiz.ordermax.base.components.PartyPickerEditPanel(new ControllerOptions());
    ...
    public EntityCondition getEntityCondition() {
        return partyPickerEditPanel.getEntityCondition();
    }
    
    @Override
    public Map<String, Object> getValues() throws BasicException {
        Map<String, Object> values = new HashMap<String, Object>();
        values.put(partyPickerEditPanel.keyId, partyPickerEditPanel.getEntityValue());
        return values;
    }    
