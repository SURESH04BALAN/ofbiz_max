...
public class JParamsCategoryId extends ParamReportEditor {
     public String getEditorClassName(){
        return "JParamsCategoryId";
    }
    /** Creates new form JParamsClosedPos */
    org.ofbiz.ordermax.base.components.CategoryPickerEditPanel pickerEditPanel = null;
    final String labelText ;
    //public static String keyId = "orderId";
    public JParamsCategoryId(String labelText) {
        this.labelText = labelText;
        initComponents();
        pickerEditPanel = new org.ofbiz.ordermax.base.components.CategoryPickerEditPanel(new ControllerOptions());
