...
public class JParamsInvoiceId extends ParamReportEditor {
         public String getEditorClassName(){
        return "JParamsInvoiceId";
    }
    /** Creates new form JParamsClosedPos */
    org.ofbiz.ordermax.base.components.InvoicePickerEditPanel pickerEditPanel = null;
    final String labelText ;
    public JParamsInvoiceId(String labelText) {
        this.labelText = labelText;
        initComponents();
        pickerEditPanel = new org.ofbiz.ordermax.base.components.InvoicePickerEditPanel(new ControllerOptions());
    ...
    public Map<String, Object> getValues() throws BasicException {
        ...
        values.put(pickerEditPanel.entityId, pickerEditPanel.getEntityValue());
        return values;
    }   
