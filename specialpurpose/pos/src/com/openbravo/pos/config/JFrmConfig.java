...
public class JFrmConfig extends javax.swing.JFrame {
    ...
    public JFrmConfig(AppProperties props) {
        ...
        try {
            this.setIconImage(ImageIO.read(JFrmConfig.class.getResourceAsStream("/com/openbravo/images/favicon.png")));
        } catch (IOException e) {
        }   
    ...
    public static void main(final String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {                    
                 //su   UIManager.setLookAndFeel(config.getProperty("swing.defaultlaf"));
                } catch (Exception e) {
                }
