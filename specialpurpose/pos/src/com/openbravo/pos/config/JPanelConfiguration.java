...
public class JPanelConfiguration extends JPanel implements JPanelView {
    ...
    public JPanelConfiguration(AppProperties props) {
        ...
        m_panelconfig.add(new JPanelConfigPosContainer());
        ...
        m_panelconfig.add(new JPanelPosDeviceConfig());
...
//        m_panelconfig.add(new JPanelConfigPayment());
    ...
    private void saveProperties() {
        ...
        try {
            Debug.logInfo("Save File:" + config.getConfigFile().getAbsolutePath(), "test");
            config.save();
            XMLPosContainerWriter xmlWriter = new XMLPosContainerWriter(config);
