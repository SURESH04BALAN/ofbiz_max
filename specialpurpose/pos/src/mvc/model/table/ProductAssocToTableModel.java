 ...
 *
 */
public class ProductAssocToTableModel extends ActionTableModel<ProductAssoc> {
    ...
    static public enum Columns {
        ...
        ASSOCIATIONTYPE(5, 120, String.class, "Association Type", false);
    ...
    public ProductAssocToTableModel() {
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (column) {
            case PRODUCTID:
                columnValue = productAssoc.getproductId();
                break;
            case PRODUCTNAME: {
                try {
//                    Debug.logInfo(productAssoc.getproductContentTypeId() + " - " + productComposite.getContent().getcontentName(), "");
                    Product product = ProductSingleton.getProduct(productAssoc.getproductId());
                    columnValue = product.getproductName();
                } catch (Exception ex) {
                    Logger.getLogger(ProductAssocToTableModel.class.getName()).log(Level.SEVERE, null, ex);
                }
                break;
            }
