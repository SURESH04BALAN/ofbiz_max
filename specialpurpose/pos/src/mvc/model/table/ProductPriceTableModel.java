 ...
 *
 */
public class ProductPriceTableModel extends AbstractTableModel {
    ...
    static public enum Columns {
        ...
        CURRENCY(2, defaultWidth, String.class, "Currency", false),
        PRODUCTSTOREGROUP(3, 150, String.class, "Product Store Group", false),
...
//        UPDATE(13, 150, java.math.BigDecimal.class, "Update", false),
    ...
    private ListModel<ProductPriceComposite> listModel = new DefaultListModel<ProductPriceComposite>();
    private ListModelChangeListener listModelChangeListener = new ListModelChangeListener();

    public ProductPriceTableModel() {
    }

    public final void setListModel(ListModel<ProductPriceComposite> listModel) {
