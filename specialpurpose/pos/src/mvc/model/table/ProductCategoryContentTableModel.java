...
//import org.ofbiz.ordermax.composite.ProductCategoryContentComposite;
...
import org.ofbiz.ordermax.product.catalog.categorycontent.ProductCategoryContentTypeSingleton;
 ...
 *
 */
public class ProductCategoryContentTableModel extends ActionTableModel<ProductCategoryContentComposite> {
    ...
    public ProductCategoryContentTableModel() {
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        Columns[] columns = Columns.values();
        Columns column = columns[columnIndex];
        ProductCategoryContentComposite productComposite = (ProductCategoryContentComposite) listModel.getElementAt(rowIndex);
        ProductCategoryContent productCategoryContent = productComposite.getProductCategoryContent();

        switch (column) {
            case CONTENTID:
                columnValue = productCategoryContent.getcontentId();
                break;
            case CONTENTTYPEID: {
                try {
                    Debug.logInfo(productCategoryContent.getprodCatContentTypeId()+ " - " + productComposite.getContent().getcontentName(), "");
                    ProductCategoryContentType product = ProductCategoryContentTypeSingleton.getProductCategoryContentType(productCategoryContent.getprodCatContentTypeId());
            ...
            case FROMDATETIME:
                columnValue = productCategoryContent.getfromDate();
                break;

            case THRUDATE:
                columnValue = productCategoryContent.getthruDate();
                break;
            case PurchaseFromDate:
                columnValue = productCategoryContent.getpurchaseFromDate();
                break;

            case PurchaseThruDate:
                columnValue = productCategoryContent.getpurchaseThruDate();
                break;
            case UseCountLimit:
                columnValue = productCategoryContent.getuseCountLimit();
                break;
