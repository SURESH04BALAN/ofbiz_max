 ...
 * @param <T>
 */
public class PaymentTypeListCellRenderer extends JLabel implements
        ListCellRenderer<PaymentType> {
    ...
    public PaymentTypeListCellRenderer(DisplayNameInterface.DisplayTypes showKey) {
        super();
        setOpaque(true);
    ...
    public Component getListCellRendererComponent(JList<? extends PaymentType> list,
            PaymentType value, int index, boolean isSelected, boolean cellHasFocus) {
        if (isSelected) {
    ...
    protected String toString(PaymentType obj) {
        if (obj == null) {
            return "";
        }
        if (obj == null) {
