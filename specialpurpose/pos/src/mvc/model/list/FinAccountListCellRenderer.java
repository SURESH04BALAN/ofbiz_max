 ...
 * @param <T>
 */
public class FinAccountListCellRenderer extends JLabel implements
        ListCellRenderer<FinAccount> {
    ...
    public FinAccountListCellRenderer() {
        super();
        setOpaque(true);
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends FinAccount> list,
            FinAccount value, int index, boolean isSelected, boolean cellHasFocus) {
        if (isSelected) {
...
//        }
    ...
    private String toString(FinAccount obj) {
        if (obj == null) {
            return "";
        }
        if (obj == null) {
