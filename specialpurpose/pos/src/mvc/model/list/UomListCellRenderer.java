 ...
 * @param <T>
 */
public class UomListCellRenderer extends JLabel implements
        ListCellRenderer<Uom> {
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends Uom> list,
            Uom value, int index, boolean isSelected, boolean cellHasFocus) {
        if (isSelected) {
...
//        }
    ...
    private String toString(Uom obj) {
        if (obj == null) {
            return "";
        }
        if (obj == null) {
