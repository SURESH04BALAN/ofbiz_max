 ...
 * @param <T>
 */
public class PartyListCellRenderer extends JLabel implements
        ListCellRenderer<Account> {
    ...
    public PartyListCellRenderer(DisplayNameInterface.DisplayTypes showKey) {
        super();
        setOpaque(true);
        this.showKey = showKey;
    }
    public PartyListCellRenderer() {
        super();
        setOpaque(true);
...
//        }
    ...
    private String toString(Account obj) {
