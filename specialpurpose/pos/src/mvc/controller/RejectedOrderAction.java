 ...
 * @author siranjeev
 */
public class RejectedOrderAction extends ScreenAction {
    ...
    public static final String nameStr = "REJECT ORDER";
    ...
    public RejectedOrderAction(javax.swing.JDesktopPane desktopPane,  OrderActionInterface orderActInterface) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION,
                RejectedOrderAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderActionInterface = orderActInterface;
    }

    public RejectedOrderAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION, name, session, desktopPane);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }

    public RejectedOrderAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (orderActionInterface != null) {
            final Order order = orderActionInterface.getOrder();
            if (rejectOrder(order.getOrderId())) {
    ...
    public boolean rejectOrder(String orderId) {
        ...
        return OrderChangeHelper.rejectOrder(session.getDispatcher(), session.getUserLogin(), orderId);
