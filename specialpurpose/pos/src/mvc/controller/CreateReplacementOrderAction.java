 ...
 * @author siranjeev
 */
public class CreateReplacementOrderAction extends ScreenAction {
    ...
    public static final String nameStr = "Create Replacement Order";
    ...
    public CreateReplacementOrderAction(javax.swing.JDesktopPane desktopPane, OrderActionInterface orderActInterface) {
        super(ActionType.CREATE_REPLACEMENT_ORDER_ACTION,
                CreateReplacementOrderAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderActionInterface = orderActInterface;
    }

    public CreateReplacementOrderAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
        super(ActionType.CREATE_REPLACEMENT_ORDER_ACTION, name, session, desktopPane);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }

    public CreateReplacementOrderAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
        super(ActionType.CREATE_REPLACEMENT_ORDER_ACTION, session);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }
