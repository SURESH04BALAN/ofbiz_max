 ...
 * @author siranjeev
 */
public class PaymentGroupOrderAction extends ScreenAction {
    ...
    public static final String nameStr = "Multiple Payment To Order ";
    ...
    public PaymentGroupOrderAction(javax.swing.JDesktopPane desktopPane, OrderReturnActionInterface orderReturnActionInterface) {
        super(ActionType.EDIT_SALES_INVOICE_ACTION,
                PaymentGroupOrderAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderReturnActionInterface = orderReturnActionInterface;
    }

    public PaymentGroupOrderAction(javax.swing.JDesktopPane desktopPane, OrderActionInterface orderActInterface) {
        super(ActionType.PAY_PURCHASE_ORDER_ACTION,
                PaymentGroupOrderAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderActionInterface = orderActInterface;
    }

    public PaymentGroupOrderAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
    ...
    public PaymentGroupOrderAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, PartyIdInterface partyIdInterface,
    ...
    public PaymentGroupOrderAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
...
//            for (final Order order : orderCompListModel.getList()) {
        try {
            ...
            if (orderActionInterface != null) {
                ...
                CustomerPaymentGroupInvoiceController.runController(options);// paymentInvoiceController = new CustomerPaymentInvoiceController(partyIdInterface.getPartyId(), orderIdInterface.getOrderId() , paymentAmountInterface.getPaymentAmount(), session);
