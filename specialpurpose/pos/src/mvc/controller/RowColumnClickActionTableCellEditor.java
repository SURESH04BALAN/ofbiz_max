 ...
 *
 */
public class RowColumnClickActionTableCellEditor extends ActionTableCellEditor {
    ...
    public RowColumnClickActionTableCellEditor(OrderEnteryPanelInterface orderPanel, TableCellEditor editor, ProductDataTreeLoader prodArray, java.awt.Frame parent, boolean modal, XuiSession sessionVal) {
        super(editor);
        this.parent = parent;
        this.modal = modal;
    ...
    public RowColumnClickActionTableCellEditor(TableCellEditor editor) {
        super(editor);
    }
