 ...
 * @author siranjeev
 */
public class CompleteOrderAction extends ScreenAction {
    ...
    public static final String nameStr = "COMPLETE ORDER";
    ...
    public CompleteOrderAction(javax.swing.JDesktopPane desktopPane,  OrderActionInterface orderActInterface) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION,
                CompleteOrderAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderActionInterface = orderActInterface;
    }

    public CompleteOrderAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION, name, session, desktopPane);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }

    public CompleteOrderAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (orderActionInterface != null) {
            final Order order = orderActionInterface.getOrder();
            if (completeOrder(order.getOrderId())) {
    ...
    public boolean completeOrder(String orderId) {
        ...
        return OrderChangeHelper.completeOrder(session.getDispatcher(), session.getUserLogin(), orderId);
