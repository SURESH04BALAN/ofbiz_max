 ...
 * @author siranjeev
 */
public class ProductIdMaintainVerifyValidator extends BaseInputVerifier {
    public static final String module = ProductIdMaintainVerifyValidator.class.getName();
    private GenericValue party = null;
    boolean productIdExists;

    public boolean isProductIdExists() {
        return productIdExists;
    }

    public void setProductIdExists(boolean productIdExists) {
        this.productIdExists = productIdExists;
    }



    public ProductIdMaintainVerifyValidator(JTextField field, XuiSession session) {
        this.field = field;
    ...
    public ProductIdMaintainVerifyValidator(JTextField field,boolean yieldFocusWhenEmpty, XuiSession session) {
        this.field = field;
        this.session = session;
