 ...
 * @author siranjeev
 */
public class PrintInvoiceAction extends ScreenAction {
    ...
    public PrintInvoiceAction(javax.swing.JDesktopPane desktopPane, OrderActionInterface orderActInterface) {
        super(ActionType.PRINT_PURCHASE_INVOICE_ACTION,
                PrintInvoiceAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderActionInterface = orderActInterface;
    }

    public PrintInvoiceAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<InvoiceComposite> invoiceCompListModel) {
    ...
    public PrintInvoiceAction(ListAdapterListModel<InvoiceComposite> invoiceCompListModel, XuiSession session) {
...
//                    report.reportArgs.put("OrderFinancialData", orderFinancialData);
                    ...
                    Logger.getLogger(PrintInvoiceAction.class.getName()).log(Level.SEVERE, null, ex);
                }
