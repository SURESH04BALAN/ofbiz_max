...
public class PosProductCreateAction extends ScreenAction {        
    static public final String nameStr = "Pos Product";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
       ControllerOptions controllerOptions = null;
    public PosProductCreateAction(XuiSession session, ControllerOptions controllerOptions, javax.swing.JDesktopPane desktopPane) {
    ...
    public PosProductCreateAction(ControllerOptions controllerOptions) {
        super(ActionType.PRODUCT_ENQUIRE_ACTION,nameStr, ControllerOptions.getSession(), ControllerOptions.getDesktopPane());
        this.setName(nameStr);
        this.setIconPath(iconPathStr);
        this.setIconPathSmall(iconPathSmallStr);
        this.controllerOptions = controllerOptions;
...
//        }
        ...
        ProductCatalogMainScreen.runController(options);
        //ProductCategoryManageMainScreen productMaintainController = new ProductCategoryManageMainScreen( options, session);
