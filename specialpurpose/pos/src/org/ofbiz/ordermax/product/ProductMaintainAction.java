...
public class ProductMaintainAction extends ScreenAction {        
    static public final String nameStr = "Product Maintain";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public ProductMaintainAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public ProductMaintainAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        options.setShowFullProductScreen(true);
