...
public class MaintainSupplierProductAction extends ScreenAction {        
    final String nameStr = "Maintain Supplier Productl";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public MaintainSupplierProductAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public MaintainSupplierProductAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        MaintainSupplierProductController findOrderListMain = new MaintainSupplierProductController( false, session);
    ...
    static class LoadOrderListActionFactory implements ScreenClassFactoryInterface {
        ...
        public ScreenAction createAction(String name, XuiSession session, JDesktopPane desktopPane) {
            return new MaintainSupplierProductAction(name, session, desktopPane);
        }
  
               
        @Override
        public ScreenAction createAction(XuiSession session, JDesktopPane desktopPane) {
             return new MaintainSupplierProductAction(session, desktopPane);
        }
    }
