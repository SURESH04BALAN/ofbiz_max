 ...
 * @author siranjeev
 */
public class CategoryTreeSelectionPanelFrame extends javax.swing.JPanel {
...
//        DefaultListModel prevMovel = new DefaultListModel();
        ...
        productListSelectionModel = new JListBoxSelectionModel<TreeNode>(new TreeNodeListCellRenderer(DisplayNameInterface.DisplayTypes.SHOW_NAME_AND_CODE));
...
/*                            int row = panel.getLastEmptyRow();
    ...
    void addItem(TreeNode prodNode) {
        try {
            ...
            if (productListSelectionModel.dataListModel.indexOf(prodNode) > -1) {
                return;
            } else {
                productListSelectionModel.dataListModel.add(prodNode);
                selectionChanged = true;
            }
        } catch (Exception ex) {
    ...
    static public class TreeNodeListCellRenderer extends JLabel implements
            ListCellRenderer<TreeNode> {
        ...
        DisplayNameInterface.DisplayTypes showKey;
         ...
         public TreeNodeListCellRenderer(DisplayNameInterface.DisplayTypes showKey) {
            super();
            setOpaque(true);
            this.showKey = showKey;
        }

        public TreeNodeListCellRenderer() {
            super();
            setOpaque(true);
        ...
        @Override
        public Component getListCellRendererComponent(JList<? extends TreeNode> list,
                TreeNode value, int index, boolean isSelected, boolean cellHasFocus) {
            if (isSelected) {
...
//        }
        ...
        private String toString(TreeNode obj) {
            if (obj == null) {
                return "";
            } else {
                return obj.toString();
