...
public class ProductPrintShelfLabelAction extends ScreenAction {        
    final String nameStr = "Print Shelf Labels";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public ProductPrintShelfLabelAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public ProductPrintShelfLabelAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        ProductPrintShelfLabelController findOrderListMain = new ProductPrintShelfLabelController( controllerOptions, session);
    ...
    static class LoadOrderListActionFactory implements ScreenClassFactoryInterface {
        ...
        public ScreenAction createAction(String name, XuiSession session, JDesktopPane desktopPane) {
            return new ProductPrintShelfLabelAction(name, session, desktopPane);
        }

               
        @Override
        public ScreenAction createAction(XuiSession session, JDesktopPane desktopPane) {
             return new ProductPrintShelfLabelAction(session, desktopPane);
        }
    }
