...
public class FindProductListAction extends ScreenAction {        
    final String nameStr = "Product Search";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
    ControllerOptions options = null;     
    public FindProductListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public FindProductListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        FindProductListController findOrderListMain = new FindProductListController( options, session);
