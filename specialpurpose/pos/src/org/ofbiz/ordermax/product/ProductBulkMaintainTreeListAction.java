 ...
 * @author siranjeev
 */
public class ProductBulkMaintainTreeListAction extends ScreenAction {

    static public final String nameStr = "Bulk Maintain Product";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";

    public ProductBulkMaintainTreeListAction(String name, ControllerOptions options) {
        super(ActionType.PRODUCT_PRICING_LIST_ACTION, ControllerOptions.getSession(), ControllerOptions.getDesktopPane());
    ...
    public ProductBulkMaintainTreeListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        ProdiouctBulkMaintainTreeController.runController(options);// priceMainScreen = new ProdiouctBulkMaintainTreeController(new ControllerOptions());
       // priceMainScreen.loadTwoPanelInternalFrame(ProdiouctBulkMaintainTreeController.module, desktopPane);
    }
