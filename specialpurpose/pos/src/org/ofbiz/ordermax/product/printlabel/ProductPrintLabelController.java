 ...
 * @author siranjeev
 */
public class ProductPrintLabelController extends BaseMainScreen
        implements GetProductIdInterface, PartyIdInterface {

    public static final String module = ProductPrintLabelController.class.getName();
...
//    final ListAdapterListModel<ProductCompositeLabelPrint> orderListModel = new ListAdapterListModel<ProductCompositeLabelPrint>();
    ...
    public String getCaption() {
        ...
        return "Print Packing Labels";

    }

    public ProductPrintLabelController(ControllerOptions controllerOptions, XuiSession sess) {
        super(sess);
        this.controllerOptions = controllerOptions;
    }

    public ProductPrintLabelController(ListAdapterListModel<ProductCompositeLabelPrint> ordListModel, ControllerOptions controllerOptions, XuiSession sess) {
        super(sess);
    ...
    String defaultFileLocation = "C:\\Users\\MaxSpice\\Documents\\productlabels_working.csv";
    ...
    public void loadScreen(final ContainerPanelInterface f) {
        ...
        labelDetailPanel.printLabel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
            ...
            //            if (txtBarCode.getText().length() == 12) {
                    ...
                    String packedDate = labelDetailPanel.txtPackDate.getText();;
                    String useBy = labelDetailPanel.txtUseByDate.getText();;
                    String ingrifent = labelDetailPanel.txtIngrident.getText();;
                    String weightUom = labelDetailPanel.txtWeightUom.getText();
                    String strCountryOfOrigin = labelDetailPanel.txtCountryOfOrigin.getText();
                    ...
                    org.ofbiz.ordermax.product.CustomProductPanel.printTransperentPackingLabel(productName,
                            ...
                            useBy, ingrifent, weightUom, strCountryOfOrigin, new BigDecimal(labelDetailPanel.txtLabelCount.getText()).intValue(), pservice);
                } catch (Exception e2) {
        ...
        labelDetailPanel.btnPrintShelfLabel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < labelDetailPanel.panelSelectedTable.productCompositePrintLabelTableModel.getRowCount(); ++i) {
                    try {
                        ProductCompositeLabelPrint elem = labelDetailPanel.panelSelectedTable.productCompositePrintLabelTableModel.getRowData(i);
                        printLabel(elem);
                    } catch (Exception ex) {
        ...
        buttonPanel.btnSaveFileAs.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    Logger.getLogger(ProductPrintLabelController.class.getName()).log(Level.SEVERE, null, ex);
                } finally {
                    try {
                        out.close();
                    } catch (IOException ex) {
        ...
        buttonPanel.btnSave.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    Logger.getLogger(ProductPrintLabelController.class
...
//        panel.getProductActionTableCellEditor().addActionListener(productIdClickAction);
    ...
    protected ProductCompositeLabelPrint createProductCompositeLabelPrint(ProductComposite productComposite) {
        ...
        try {
            ...
            Logger.getLogger(PanelProductLabelPrint.class
                    .getName()).log(Level.SEVERE, null, ex);
        }
...
//            output.setCaretPosition(output.getDocument().getLength());
    ...
    public void getRowData(int i) {
        try {
            ...
            Logger.getLogger(ProductCompositeLabelPrint.class
                    .getName()).log(Level.SEVERE, null, ex);
            System.out.println(
                    "row selectd  : " + i + " column: don't care");
        }
    ...
    public String getClassName() {
     ...
     void printLabel(ProductCompositeLabelPrint elem) {
        try {
