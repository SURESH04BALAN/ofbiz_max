...
public class FindSupplierPartyListAction extends ScreenAction {        
    final String nameStr = "Supplier List";
    final String iconPathStr = "supplierIcon.png";//"clients.png";
    final String iconPathSmallStr = "supplierIcon.png";//"clients.png";
     
    public FindSupplierPartyListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
        super(ActionType.SUPPLIER_FIND_LIST_ACTION, session, desktopPane);
        this.setName(nameStr);
        this.setIconPath(iconPathStr);
        this.setIconPathSmall(iconPathSmallStr);
        loadIcons();
    }    
    public FindSupplierPartyListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
        super(ActionType.SUPPLIER_FIND_LIST_ACTION,name, session, desktopPane);
        this.setName(nameStr);
        this.setIconPath(iconPathStr);
        this.setIconPathSmall(iconPathSmallStr);
        loadIcons();
...
//        }
        ...
        FindPartyListController.runController(options);
        //FindPartyListController findOrderListMain = new FindPartyListController( null, options, session);
    ...
    static class LoadOrderListActionFactory implements ScreenClassFactoryInterface {
        ...
        public ScreenAction createAction(String name, XuiSession session, JDesktopPane desktopPane) {
            return new FindSupplierPartyListAction(name, session, desktopPane);
        }

               
        @Override
        public ScreenAction createAction(XuiSession session, JDesktopPane desktopPane) {
             return new FindSupplierPartyListAction(session, desktopPane);
        }
    }
