 ...
 * @author siranjeev
 */
public class PartyGroupTreeNode extends TreeNode{
    
    public static final String PartyGroupNodeName = PartyGroupTreeNode.class.getName();

    /*public PartyGroupTreeNode(String string1, String string2, boolean isLeaf) {
        super(string1, string2, isLeaf);
    }*/
    public PartyGroupTreeNode(String string1, String string2, boolean isLeaf, GenericValue dataObject) {
        super(string1, string2, isLeaf, dataObject);

    }
    @Override
    public String getNodeName() {
        return PartyGroupNodeName;
    }
