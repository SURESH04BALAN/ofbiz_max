 ...
 * @author siranjeev
 */
public class FindCustomerPartyListAction extends ScreenAction {

    final String nameStr = "Customer List";
    final String iconPathStr = "clients.png";
    final String iconPathSmallStr = "clients.png";

    public FindCustomerPartyListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
        super(ActionType.CUSTOMER_FIND_LIST_ACTION, session, desktopPane);
    ...
    public FindCustomerPartyListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
        super(ActionType.CUSTOMER_FIND_LIST_ACTION, name, session, desktopPane);
        this.setName(nameStr);
        this.setIconPath(iconPathStr);
        this.setIconPathSmall(iconPathSmallStr);
        loadIcons();
...
//        }
        ...
        FindPartyListController.runController(options);// findOrderListMain = new FindPartyListController(null, options, session);
    ...
    static class LoadOrderListActionFactory implements ScreenClassFactoryInterface {
        ...
        public ScreenAction createAction(String name, XuiSession session, JDesktopPane desktopPane) {
            return new FindCustomerPartyListAction(name, session, desktopPane);
        }
        ...
        public ScreenAction createAction(XuiSession session, JDesktopPane desktopPane) {
            return new FindCustomerPartyListAction(session, desktopPane);
        }
    }
