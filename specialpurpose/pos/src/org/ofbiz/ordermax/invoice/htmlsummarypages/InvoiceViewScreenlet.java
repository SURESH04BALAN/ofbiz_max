...
import org.ofbiz.ordermax.orderbase.htmlsummarypages.*;
 ...
 * @author BBS Auctions
 */
public class InvoiceViewScreenlet implements InvoiceHtmlScreenletInterface {

    public static final String module = InvoiceViewScreenlet.class.getName();
...
//editBillingAddress2.setText(htmlString);
    ...
    public String getScreenletHtml(String invoiceId) {
        ...
        try {
            result = invoke(invoiceId);
//            Debug.logInfo("resut : " + result, module);
        } catch (EventHandlerException ex) {
            Logger.getLogger(InvoiceViewScreenlet.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        Map<String, Object> values = (Map) result.get("widget");
    ...
    public Bindings invoke(String invoiceId) throws EventHandlerException {
        getClassLoader();
