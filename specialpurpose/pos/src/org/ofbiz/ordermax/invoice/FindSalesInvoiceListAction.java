...
public class FindSalesInvoiceListAction extends ScreenAction {        
    final String nameStr = "Find Sales Invoices";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public FindSalesInvoiceListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public FindSalesInvoiceListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        controllerOptions.addInvoiceType("SALES_INVOICE");
        controllerOptions.addRoleType("CUSTOMER");        
        FindInvoiceListController findOrderListMain = new FindInvoiceListController( null, controllerOptions, session);
