 ...
 * @author siranjeev
 */
public class OldPurchaseInvoiceEnteryPanel1 extends javax.swing.JPanel {

    public final static String addressHeader = "      <table class=\"basic-table\" cellspacing=\"0\">\n"
            + "        <tbody><tr>\n"
            + "          <td align=\"right\" valign=\"top\" width=\"19%\"><span class=\"label\">&nbsp;Name</span></td>\n"
            + "          <td width=\"1%\">&nbsp;</td>\n"
            + "          <td valign=\"top\" width=\"80%\">\n"
            + "            <div>"
            + "             <font size=\"2\" face=\"Georgia, Arial\" color=\"maroon\">\n"
            + "                INDIAN PALACE (SYDNEY)  \n"
            + "                &nbsp;(<a href=\"https://localhost:8443/partymgr/control/viewprofile?partyId=INDPAS&amp;amp;externalLoginKey=EL212892928556\" target=\"partymgr\" class=\"buttontext\">INDPAS</a>)\n"
            + "                <br>\n"
            + "            </font></div>\n"
            + "          </td>\n"
            + "        </tr>\n"
            ...
            + "              <span class=\"label\">&nbsp;Billing (AP) Address</span>\n"
            + "            </td>\n"
            + "            <td width=\"1%\">&nbsp;</td>\n"
            + "            <td valign=\"top\" width=\"80%\">\n"
            + "                  <div>\n"
    ...
    public static final String module = OldPurchaseInvoiceEnteryPanel1.class.getName();
...
//            dateMask1.install(panelDeliveryDate);
    ...
    public OldPurchaseInvoiceEnteryPanel1(final XuiSession session) {
...
//        btnHeaderPatryId.addActionListener(new LookupActionListner(partyIdTextField, "partyIdTextField", "BILL_FROM_VENDOR", null));
        ...
        cb = new ComponentBorder(btnItemPatryId);
        cb.install(txtLineItemPartyId);
  //      btnItemPatryId.addActionListener(new LookupActionListner(txtLineItemPartyId, "partyIdTextField", "BILL_FROM_VENDOR", null));
                ...
                if (e.getSource() instanceof JTabbedPane) {
                    ...
                    if (pane.getSelectedIndex() == 0) {
                        try {
                            ...
                            Logger.getLogger(OldPurchaseInvoiceEnteryPanel1.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        try {
...
//        btnLineItemOrderId.addActionListener(new LookupActionListner(txtLineItemorderId, "orderIdTextField", txtLineItemPartyId, "partyIdTextField", "BILL_FROM_VENDOR", parentFrame));
    ...
    private void initComponents() {
        ...
        edit30Days1 = new javax.swing.JTextField();
        ...
        jPanel16.setPreferredSize(new java.awt.Dimension(1080, 256));
        ...
        edit30Days1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        edit30Days1.setMinimumSize(new java.awt.Dimension(6, 30));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(partyIdTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                    .addComponent(editReference, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(edit30Days1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(edit30Days, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(edit60Days, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(edit90Days, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(editTotalBalance, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(editCurrOutstanding, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(edit30Days1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(panelOrderDate, javax.swing.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)
                    .addComponent(panelEntryDate, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(comboInvoiceStatus, 0, 106, Short.MAX_VALUE)
                    .addComponent(comboFacility, 0, 106, Short.MAX_VALUE)
                    .addComponent(editEnteredBy, javax.swing.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {comboFacility, comboInvoiceStatus, editEnteredBy, jPanel30, panelEntryDate, panelOrderDate});
        ...
        panelOrderHeader.add(jPanel16, java.awt.BorderLayout.PAGE_START);
        ...
        jPanel21Layout.setVerticalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbLineItemPrint, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//        reloadItemDataModel(getItemList());
    ...
    final public void setDialogFields() {
        Debug.logInfo("order.getOrderHeader().getOrderTypeId(): " + order.getInvoice().getinvoiceTypeId(), module);

        Debug.logInfo("order.getBillFromAccount(): 1", module);

        if (order.getBillFromAccount() != null && order.getBillFromAccount().getParty() != null) {
//                comboDeliveryAddress.setModel(getPurposeComboxModel(order.getBillFromAccount().getParty(), "POSTAL_ADDRESS"));
//                comboBillingAddress.setModel(getPurposeComboxModel(order.getBillFromAccount().getParty(), "POSTAL_ADDRESS"));
//                comboInvoicePhone.setModel(getPurposeComboxModel(order.getBillFromAccount().getParty(), "TELECOM_NUMBER"));
//                comboDeliveryPhone.setModel(getPurposeComboxModel(order.getBillFromAccount().getParty(), "TELECOM_NUMBER"));

            Debug.logInfo("order.getBillFromAccount(): 2", module);
            partyIdTextField.setText(order.getBillFromAccount().getParty().getParty().getpartyId());
...
//                    partyNameTextField.setText(order.getPartyName());
            ...
            order.getInvoiceContactList().outputToDebug();
            ...
            if (order.getInvoiceContactList().getBillingLocationContact() != null) {
                ...
                str = PartyContactMechHelper.getAddresHtmlString(postalMech, "Hello");
                orderToStringBuilder.append(str);
            ...
            if (order.getInvoiceContactList().getBillingLocationPhoneContact() != null) {
                ...
                if (telecomMech != null) {
                    String str = PartyContactMechHelper.getPhoneHtmlString(telecomMech, "tty");
                    orderToStringBuilder.append(str);
...
//        }
        ...
        /*
         ...
         order.getBillFromAccount().getParty(), "BILLING_LOCATION");//billFrom.getPartyContactList().getPartyContactMechPurposeList().getPartyContactPurpose("BILLING_LOCATION");
         ...
         order.getBillFromAccount().getParty(), "SHIPPING_LOCATION");//billFrom.getPartyContactList().getPartyContactMechPurposeList().getPartyContactPurpose("BILLING_LOCATION");
         ...
         pc = LoadPurchaseOrderWorker.getPartyContactFromPurpose(
         order.getBillFromAccount().getParty(), "PHONE_BILLING");//billFrom.getPartyContactList().getPartyContactMechPurposeList().getPartyContactPurpose("BILLING_LOCATION");
         ...
         pc = LoadPurchaseOrderWorker.getPartyContactFromPurpose(
         order.getBillFromAccount().getParty(), "PHONE_SHIPPING");//billFrom.getPartyContactList().getPartyContactMechPurposeList().getPartyContactPurpose("BILLING_LOCATION");
         ...
         pc = LoadPurchaseOrderWorker.getPartyContactFromPurpose(
         order.getBillFromAccount().getParty(), "BILLING_EMAIL");//billFrom.getPartyContactList().getPartyContactMechPurposeList().getPartyContactPurpose("BILLING_LOCATION");
...
//                setTotals();
    ...
    private javax.swing.JTextField edit30Days1;
