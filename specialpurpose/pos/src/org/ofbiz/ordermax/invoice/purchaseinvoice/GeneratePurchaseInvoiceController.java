 ...
 * @author siranjeev
 */
public class GeneratePurchaseInvoiceController extends BaseMainScreen {

    public static final String module = GeneratePurchaseInvoiceController.class.getName();
    ...
    public GeneratePurchaseInvoiceController( XuiSession sess) {
        super(sess);

    }

    public GeneratePurchaseInvoiceController(ListAdapterListModel<Order> ordListModel,  XuiSession sess) {
        super(sess);
