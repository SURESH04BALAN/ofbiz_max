 ...
 * @author siranjeev
 */
public class PosTerminalDetailAction extends ScreenAction {
...
//    private ListAdapterListModel<ShipmentReceiptComposite> invoiceCompListModel;
    ...
    public static final String module = PosTerminalDetailAction.class.getName();
    public static final String nameStr = "Pos Terminal";
    final String iconPathStr = "";
    final String iconPathSmallStr = "";

    private XuiSession session;

    public PosTerminalDetailAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
        super(ActionType.PRINT_PURCHASE_INVOICE_ACTION, name, session, desktopPane);

        this.session = session;
    }

    public PosTerminalDetailAction(ItemListInterface<ShipmentReceiptComposite> itemListInterface, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        PosTerminalPanel viewer = new PosTerminalPanel(options);
        if (desktopPane != null) {
