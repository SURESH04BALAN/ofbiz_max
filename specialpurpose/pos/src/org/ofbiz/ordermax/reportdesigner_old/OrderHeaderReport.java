 ...
 * @author siranjeev
 */
public class OrderHeaderReport extends OrderHeader {

    public OrderHeaderReport(GenericValue val) {
        super(val);
    }
 ...
 private java.sql.Timestamp time_issued;
    ...
    private java.lang.String billing_add1 = "10";
    private java.lang.String billing_add2 = "JUMAL PLACE";
    private java.lang.String billing_add3;
    private java.lang.String billing_city = "SMITHFIELD";
    private java.lang.String billing_zip = "2164";
    private java.lang.String billing_state = "NSW";
    ...
    public void setOrderPartyDetails(XuiSession session, Order order) {
        this.receiver_handphone = "";
        this.receiver_phone1 = "";
        this.receiver_phone2 = "";
        this.receiver_fax = "";
        this.receiver_email = "";

        if ("PERSON".equals(order.getBillToAccount().getParty().getPartyTypeId())) {
            this.entity_name = PartyHelper.getPartyName(order.getBillToAccount().getParty().getPerson().getGenericValueObj(), false);
        } else {
            this.entity_name =  PartyHelper.getPartyName(order.getBillToAccount().getParty().getPartyGroup().getGenericValueObj(), false);
        }
        ...
        for (GenericValue val : valueList) {
            Debug.logInfo("contactMechId: " + val.getString("contactMechId"), module);
        ...
        if (deliveryPostalAddress != null) {
            this.receiver_add1 = deliveryPostalAddress.getGenericValueObj().getString("address1");
            this.receiver_add2 = deliveryPostalAddress.getGenericValueObj().getString("address2");
            this.receiver_add3 = deliveryPostalAddress.getGenericValueObj().getString("address3");
            this.receiver_city = deliveryPostalAddress.getGenericValueObj().getString("city");
            this.receiver_zip = deliveryPostalAddress.getGenericValueObj().getString("postalCode");
            this.receiver_state = deliveryPostalAddress.getGenericValueObj().getString("stateProvinceGeoId");
            this.receiver_country = deliveryPostalAddress.getGenericValueObj().getString("countryGeoId");
        }

        PostalAddress billingPostalAddress = null;
        Debug.logInfo("orderId: " + orderId, module);
        whereClauseMap.clear();
        whereClauseMap.put("orderId", orderId);
        whereClauseMap.put("contactMechPurposeTypeId", "BILLING_LOCATION");
        valueList = PosProductHelper.getGenericValueListsWithSelection("OrderContactMech", whereClauseMap, null, ControllerOptions.getSession().getDelegator());
        for (GenericValue val : valueList) {
            Debug.logInfo("contactMechId: " + val.getString("contactMechId"), module);
            billingPostalAddress = LoadAccountWorker.getPostalAddress(val.getString("contactMechId"));
            break;
            //  getInstance().valueMap.put(productPriceType.getproductStoreGroupId(), productPriceType);
        }

        if (billingPostalAddress != null) {
            this.billing_add1 = billingPostalAddress.getGenericValueObj().getString("address1");
            this.billing_add2 = billingPostalAddress.getGenericValueObj().getString("address2");
            this.billing_add3 = billingPostalAddress.getGenericValueObj().getString("address3");
            this.billing_city = billingPostalAddress.getGenericValueObj().getString("city");
            this.billing_zip = billingPostalAddress.getGenericValueObj().getString("postalCode");
            this.billing_state = billingPostalAddress.getGenericValueObj().getString("stateProvinceGeoId");
            this.billing_country = billingPostalAddress.getGenericValueObj().getString("countryGeoId");
        }

//        List<Map<String, Object>> partyMechList = ContactMechWorker.getPartyContactMechValueMaps(session.getDelegator(), orderHeader.getPartyId(), false);
  /*      if (partyMechList != null) {
         String purposeId = Order.DELIVERY_LOCATION;
         String shippConactMechId = orderHeader.getContactMechId(purposeId);
         ...
         GenericValue postalMech = OrderMaxUtility.getContachMechObject(shippConactMechId, partyMechList);
         if (postalMech != null) {
         ...
         try {
         this.receiver_company_name = PartyListSingleton.getAccount(orderHeader.getPartyId()).getDisplayName();
         } catch (Exception ex) {
         }
         ...
         String billingAddressMechId = orderHeader.getContactMechId(purposeId);
         ...
         //        editDeliveryAddress.setText(OrderMaxUtility.getContachMechDetail(billingAddressMechId, partyMechList));
         postalMech = OrderMaxUtility.getContachMechObject(billingAddressMechId, partyMechList);
         if (postalMech != null) {
         this.billing_handphone = "";
         this.billing_phone1 = "";
         this.billing_phone2 = "";
         this.billing_fax = "";
         this.billing_email = "";
         ...
         try {
         this.billing_company_name = PartyListSingleton.getAccount(orderHeader.getPartyId()).getDisplayName();
         } catch (Exception ex) {
         }
         this.billing_add1 = postalMech.getString("address1");
         this.billing_add2 = postalMech.getString("address2");
         this.billing_add3 = postalMech.getString("address3");
         this.billing_city = postalMech.getString("city");
         this.billing_zip = postalMech.getString("postalCode");
         this.billing_state = postalMech.getString("stateProvinceGeoId");
         this.billing_country = postalMech.getString("countryGeoId");
         }

         purposeId = Order.DELIVERY_PHONE;
         String phoneConactMechId = orderHeader.getContactMechId(purposeId);
         ...
         postalMech = OrderMaxUtility.getContachMechObject(phoneConactMechId, partyMechList);
         if (postalMech != null) {
         this.receiver_phone1 = OrderMaxUtility.getFormatedTelecom(postalMech);
         this.receiver_phone2 = OrderMaxUtility.getFormatedTelecom(postalMech);
         this.receiver_fax = "";
         this.receiver_email = "";
         }

         purposeId = Order.PRIMARY_PHONE;
         String primaryPhoneConactMechId = orderHeader.getContactMechId(purposeId);
         if (primaryPhoneConactMechId == null) {
         purposeId = OrderMaxUtility.getValidContactMechIdPurposeTypeId(partyMechList, ContactMechPanelMain.Phone, ContactMechPanelMain.TELECOMNUMBER);
         primaryPhoneConactMechId = OrderMaxUtility.getValidContactMechId(purposeId, partyMechList, ContactMechPanelMain.Phone, ContactMechPanelMain.TELECOMNUMBER);//
         orderHeader.addContactMechId(purposeId, primaryPhoneConactMechId);
         }

         postalMech = OrderMaxUtility.getContachMechObject(primaryPhoneConactMechId, partyMechList);
         if (postalMech != null) {
         this.receiver_handphone = OrderMaxUtility.getFormatedTelecom(postalMech);
         }

         purposeId = Order.BILLING_EMAIL;
         String emailConactMechId = orderHeader.getContactMechId(purposeId);
         this.receiver_email = OrderMaxUtility.getContachMechDetail(emailConactMechId, partyMechList);

         try {
         if (orderHeader.getBillToAccount() != null) {
         this.entity_name = orderHeader.getBillToAccount().getParty().getDisplayName(); //PartyListSingleton.getAccount(.getPartyId()).getDisplayName();
         }
         } catch (Exception ex) {
         }
         }
