...
public class ComponentBorder implements Border {
     ...
     * @param component the component to be added in the Border area
     * @param edge a valid Edge enum of TOP, LEFT, BOTTOM, RIGHT
     * @param alignment the alignment of the component along the specified Edge.
...
//
    ...
    static public void doubleRaisedLoweredBevelBorder(final JPanel panel, final String caption) {
        if (caption != null) {
...
//        panel.setBorder(compound);
            panel.setBorder(BorderFactory.createTitledBorder(BorderFactory
                    .createLineBorder(Color.LIGHT_GRAY), caption));
            changeFont(panel, new java.awt.Font("Tahoma", 0, 12));
        }
    }

    static public void loweredBevelBorder(final JPanel panel, final String caption) {

        Border raisedbevel, loweredbevel;

        raisedbevel = BorderFactory.createTitledBorder("");//new Color(0xF0F0F0), 1, true);
        loweredbevel = BorderFactory.createLoweredBevelBorder();

        //Compound borders
        //This creates a nice frame.
        Border compound = raisedbevel; //BorderFactory.createCompoundBorder(                    raisedbevel, loweredbevel);
    ...
    static public void etchedBorder(final JPanel panel, final String caption) {
