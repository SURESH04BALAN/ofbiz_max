...
* <p>
     * <b>Examples:</b><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 })) -->
     * true</tt><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }), 1, 2) -->
     * false, 3 missing</tt><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }), 1, 99) -->
     * false, 3 missing</tt>
     */
    @SafeVarargs
...
* <p>
     * <b>Examples:</b><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }),
     * Arrays.asList(new Integer[] { })) --> true</tt><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }),
     * Arrays.asList(new Integer[] { 1, 2 })) --> false, 3 missing</tt><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }),
     * Arrays.asList(new Integer[] { 1, 99 })) --> false, 3 missing</tt>
     */
    ...
    /**
     * Checks if the collection contains exactly the given
     * <tt>mustHaveItems</tt>.
     *     
* <p>
     * <b>Examples:</b><br>
     ...
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }), 1, 99) -->
     * false</tt><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }), 1, 2, 3) -->
     * true</tt>
     */
    @SafeVarargs
...
* <p>
     * <b>Examples:</b><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }),
     * Arrays.asList(new Integer[] { })) --> false</tt><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }),
     * Arrays.asList(new Integer[] { 1, 99 })) --> false</tt><br>
     * <tt>containsOnly(Arrays.asList(new Integer[] { 1, 2, 3 }),
     * Arrays.asList(new Integer[] { 1, 2, 3 })) --> true</tt>
     */
