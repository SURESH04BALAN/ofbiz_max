 ...
 * @author siranjeev
 */
public class PdfFileViewerAction extends ScreenAction {
...
//    private ListAdapterListModel<ShipmentReceiptComposite> invoiceCompListModel;
    ...
    public static final String module = PdfFileViewerAction.class.getName();
    public static final String nameStr = "Invoice Pdf Viewer";
    final String iconPathStr = "";
    final String iconPathSmallStr = "";

    private XuiSession session;

    public PdfFileViewerAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
        super(ActionType.PRINT_PURCHASE_INVOICE_ACTION, name, session, desktopPane);

        this.session = session;
    }

    public PdfFileViewerAction(ItemListInterface<ShipmentReceiptComposite> itemListInterface, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        PdfFileViewerPanel viewer = new PdfFileViewerPanel(options);
        if (desktopPane != null) {
