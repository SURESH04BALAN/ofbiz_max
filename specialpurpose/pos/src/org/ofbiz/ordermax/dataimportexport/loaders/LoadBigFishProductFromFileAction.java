 ...
 * @author siranjeev
 */
public class LoadBigFishProductFromFileAction extends AbstractAction {
 ...
 private JTextField textField=null;    
    public LoadBigFishProductFromFileAction(JTextField field,ListAdapterListModel<BigFishProduct> personListModel, XuiSession session) {
...
//    LoadProductFromFileWorker loadPersonsWorker = new LoadProductFromFileWorker(personListModel,"C:\\backup\\Real_Data\\generated_product_load.csv", session);        
        GenerateBFProductFromFileWorker loadPersonsWorker = new GenerateBFProductFromFileWorker(personListModel,textField.getText(), session);                
