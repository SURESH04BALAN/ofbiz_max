 ...
 * @author siranjeev
 */
public class LoadSimpleProductCompositeFromFileWorker extends SwingWorker<List<ProductComposite>, ProductComposite> {

    public static final String module = LoadSimpleProductCompositeFromFileWorker.class.getName();
    ...
    public LoadSimpleProductCompositeFromFileWorker(ListAdapterListModel<ProductComposite> personListModel, String fileName, XuiSession delegator) {
...
//            GenerateCSV.generateCsvFile("C:\\backup\\Real_Data\\generated_product.csv", listMap, selectedField);
        ...
        /*
         ...
         try {
         Map<String, Object> toStore = supplierProduct.getValuesMap();
