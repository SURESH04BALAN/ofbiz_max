 ...
 * @author siranjeev
 */
public class LoadSimpleProductCompositeFromFileAction extends AbstractAction {
 ...
 private JTextField textField=null;    
    public LoadSimpleProductCompositeFromFileAction(JTextField field,ListAdapterListModel<ProductComposite> personListModel, XuiSession session) {
...
//    LoadProductFromFileWorker loadPersonsWorker = new LoadProductFromFileWorker(personListModel,"C:\\backup\\Real_Data\\generated_product_load.csv", session);        
        LoadProductCompositeFromFileWorker loadPersonsWorker = new LoadProductCompositeFromFileWorker(personListModel,textField.getText(), session);                
