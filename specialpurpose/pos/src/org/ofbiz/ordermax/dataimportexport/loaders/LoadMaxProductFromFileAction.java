 ...
 * @author siranjeev
 */
public class LoadMaxProductFromFileAction extends AbstractAction {
    ...
    public LoadMaxProductFromFileAction(JTextField field,ListAdapterListModel<ProductComposite> personListModel, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        LoadMaxProductFromFileWorker loadPersonsWorker = new LoadMaxProductFromFileWorker(personListModel,textField.getText(), session);                
