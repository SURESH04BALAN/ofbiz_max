 ...
 */
public class CustomerPaymentInvoiceCapturePanel extends javax.swing.JPanel implements BaseMainPanelInterface {

    public static final String module = CustomerPaymentInvoiceCapturePanel.class.getName();
...
//    private ListAdapterListModel<InvoiceComposite> invoiceCompositeListModel = new ListAdapterListModel<InvoiceComposite>();
     ...
     */
    public CustomerPaymentInvoiceCapturePanel() {
        initComponents();
        tablePaymentApplication.setModel(invoiceCompositePaymentTableModel);
        setupEditOrderTable();
    }

    public CustomerPaymentInvoiceCapturePanel(XuiSession session) {
...
//            tablePaymentApplication.setModel(model);
    ...
    private void initComponents() {
        ...
        btnSaveOrder.setIcon(new javax.swing.ImageIcon("C:\\backup\\ofbiz-12.04.02\\images\\icons\\famfamfam\\disk.png")); // NOI18N
