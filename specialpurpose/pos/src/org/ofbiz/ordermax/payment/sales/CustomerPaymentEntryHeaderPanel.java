...
import org.ofbiz.ordermax.generic.entitypanelsimpl.SimpleFacilityPanel;
 ...
 */
public class CustomerPaymentEntryHeaderPanel extends javax.swing.JPanel implements BaseMainPanelInterface {

    public static final String module = CustomerPaymentEntryHeaderPanel.class.getName();
                                ...
                                if (lsm.isSelectedIndex(i)) {
                                    ...
                                    if (mapList.containsKey(paymentMethod.getpaymentMethodId())) {
                                        ...
                                        for (Map.Entry<String, GenericValue> mapIter : valList.entrySet()) {
                                            Debug.logInfo("mapIter key  " + mapIter.getKey(), module);
                                        }
    ...
    public CustomerPaymentEntryHeaderPanel(ControllerOptions options)//  XuiSession session, String paymentParentTypeId) {
    {
