 ...
 * @author siranjeev
 */
public class CustomerPaymentListAction extends ScreenAction {

    final String nameStr = "Sales Payment";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";

    public CustomerPaymentListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public CustomerPaymentListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        CustomerPaymentInvoiceController.runController(controllerOptions);// paymentInvoiceController = new CustomerPaymentInvoiceController(null);
