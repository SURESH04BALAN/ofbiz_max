...
public class FindSalesPaymentListAction extends ScreenAction {        
    final String nameStr = "Customer Payment List";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public FindSalesPaymentListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public FindSalesPaymentListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
                ...
                options.addPaymentType("CUSTOMER_PAYMENT");                        
