 ...
 * @author siranjeev
 */
public class FindOrderByPartyListController extends BaseMainScreen implements
        OrderIdInterface {

    public static final String module = FindOrderByPartyListController.class.getName();
    public FindOrderByPartyListPanel panel = null;
    ...
    public FindOrderByPartyListController(ControllerOptions options, XuiSession sess) {
        super(sess);
        controllerOptions = options;
    }

    public FindOrderByPartyListController(ListAdapterListModel<OrderHeaderAndRoleSummary> ordListModel, ControllerOptions options,  XuiSession sess) {
        super(sess);
    ...
    public void loadScreen(final ContainerPanelInterface f) {
        ...
        panel = new FindOrderByPartyListPanel(controllerOptions.getCopy());
