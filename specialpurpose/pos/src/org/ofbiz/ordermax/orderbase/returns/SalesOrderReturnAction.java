 ...
 * @author siranjeev
 */
public class SalesOrderReturnAction extends ScreenAction {

    final String nameStr = "Sales Order Return";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";

    public SalesOrderReturnAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public SalesOrderReturnAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
