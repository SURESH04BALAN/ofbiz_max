...
public class FindSalesOrderReturnListAction extends ScreenAction {        
    final String nameStr = "Sales Order Return List";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public FindSalesOrderReturnListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public FindSalesOrderReturnListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
