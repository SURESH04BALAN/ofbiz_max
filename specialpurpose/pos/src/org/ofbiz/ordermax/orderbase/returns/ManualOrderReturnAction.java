 ...
 * @author siranjeev
 */
public class ManualOrderReturnAction extends ScreenAction {
    ...
    public static final String nameStr = "MANUAL ORDER RETURN";
    ...
    public ManualOrderReturnAction(javax.swing.JDesktopPane desktopPane,  OrderReturnActionInterface orderActInterface) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION,
                ManualOrderReturnAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderReturnActionInterface = orderActInterface;
    }

    public ManualOrderReturnAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION, name, session, desktopPane);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }

    public ManualOrderReturnAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (orderReturnActionInterface != null) {
            ...
            if (manualOrderReturn(orderReturn)) {
    ...
    public boolean manualOrderReturn(ReturnHeaderComposite returnHeader) {

         try {
            return LoadOrderReturnWorker.setStatusToReturnManual(returnHeader, session) == OrderMaxUtility.ServiceReturnStatus.SUCCESS;
        } catch (Exception ex) {
