 ...
 * @author siranjeev
 */
public class AcceptOrderReturnAction extends ScreenAction {
    ...
    public static final String nameStr = "ACCEPT RETURN";
    ...
    public AcceptOrderReturnAction(javax.swing.JDesktopPane desktopPane,  OrderReturnActionInterface orderActInterface) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION,
                AcceptOrderReturnAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderReturnActionInterface = orderActInterface;
    }

    public AcceptOrderReturnAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION, name, session, desktopPane);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }

    public AcceptOrderReturnAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (orderReturnActionInterface != null) {
            ...
            if (acceptOrderReturn(orderReturn)) {
     ...
     public boolean acceptOrderReturn(ReturnHeaderComposite returnHeader) {

         try {
            return LoadOrderReturnWorker.setStatusToReturnAccepted(returnHeader, session) == OrderMaxUtility.ServiceReturnStatus.SUCCESS;
        } catch (Exception ex) {
