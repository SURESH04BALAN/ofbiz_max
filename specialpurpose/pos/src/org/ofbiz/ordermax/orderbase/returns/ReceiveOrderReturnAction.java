 ...
 * @author siranjeev
 */
public class ReceiveOrderReturnAction extends ScreenAction {
    ...
    public static final String nameStr = "RECEIVE RETURN";
    ...
    public ReceiveOrderReturnAction(javax.swing.JDesktopPane desktopPane,  OrderReturnActionInterface orderActInterface) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION,
                ReceiveOrderReturnAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderReturnActionInterface = orderActInterface;
    }

    public ReceiveOrderReturnAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION, name, session, desktopPane);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }

    public ReceiveOrderReturnAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (orderReturnActionInterface != null) {
            ...
            if (receiveOrderReturn(orderReturn)) {
    ...
    public boolean receiveOrderReturn(ReturnHeaderComposite returnHeader) {

        try {
            return LoadOrderReturnWorker.setStatusToReturnReceived(returnHeader, session) == OrderMaxUtility.ServiceReturnStatus.SUCCESS;
        } catch (Exception ex) {
