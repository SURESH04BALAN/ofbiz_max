 ...
 * @author siranjeev
 */
public class CancelOrderReturnAction extends ScreenAction {
    ...
    public static final String nameStr = "CANCEL RETURN";
    ...
    public CancelOrderReturnAction(javax.swing.JDesktopPane desktopPane,  OrderReturnActionInterface orderActInterface) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION,
                CancelOrderReturnAction.nameStr, XuiContainer.getSession(), desktopPane);
        this.orderReturnActionInterface = orderActInterface;
    }

    public CancelOrderReturnAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane, ListAdapterListModel<Order> orderCompListModel) {
        super(ActionType.APPROVE_PURCHASE_ORDER_ACTION, name, session, desktopPane);
        this.orderCompListModel = orderCompListModel;
        this.session = session;
    }

    public CancelOrderReturnAction(ListAdapterListModel<Order> orderCompListModel, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (orderReturnActionInterface != null) {
            ...
            if (cancelOrderReturn(orderReturn)) {
    ...
    public boolean cancelOrderReturn(ReturnHeaderComposite returnHeader) {

         try {
            return LoadOrderReturnWorker.setStatusToReturnCancelled(returnHeader, session) == OrderMaxUtility.ServiceReturnStatus.SUCCESS;
        } catch (Exception ex) {
