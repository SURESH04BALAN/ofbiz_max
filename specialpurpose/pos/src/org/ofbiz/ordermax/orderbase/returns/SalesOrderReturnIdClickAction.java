 ...
 * @author siranjeev
 */
public class SalesOrderReturnIdClickAction implements ActionListener {
    ...
    public SalesOrderReturnIdClickAction(OrderReturnIdInterface prodInterface, JFrame pFrame, javax.swing.JDesktopPane desktopPane, XuiSession session) {
