 ...
 * @author siranjeev
 */
public class PurchaseOrderReturnAction extends ScreenAction {

    final String nameStr = "Order Return";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";

    public PurchaseOrderReturnAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public PurchaseOrderReturnAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        option.addReturnHeaderType("VENDOR_RETURN");
        option.addRoleType("SUPPLIER");
