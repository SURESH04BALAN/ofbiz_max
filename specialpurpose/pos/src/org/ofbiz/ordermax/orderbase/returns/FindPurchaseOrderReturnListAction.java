...
public class FindPurchaseOrderReturnListAction extends ScreenAction {        
    final String nameStr = "Order Return List";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public FindPurchaseOrderReturnListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public FindPurchaseOrderReturnListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
