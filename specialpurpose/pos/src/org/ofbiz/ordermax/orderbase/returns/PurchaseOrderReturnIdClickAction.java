 ...
 * @author siranjeev
 */
public class PurchaseOrderReturnIdClickAction implements ActionListener {
    ...
    public PurchaseOrderReturnIdClickAction(OrderReturnIdInterface prodInterface, JFrame pFrame, javax.swing.JDesktopPane desktopPane, XuiSession session) {
