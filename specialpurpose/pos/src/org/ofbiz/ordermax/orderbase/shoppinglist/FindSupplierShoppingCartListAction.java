...
public class FindSupplierShoppingCartListAction extends ScreenAction {        
    final String nameStr = "Order Return List";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public FindSupplierShoppingCartListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public FindSupplierShoppingCartListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        FindOrderReturnListController findPaymentListController = new FindOrderReturnListController( controllerOptions, session);
        findPaymentListController.loadTwoPanelInternalFrame(FindOrderReturnListController.module, desktopPane);
