 ...
 * @author siranjeev
 */
public class SalesShoppingCartListIdClickAction implements ActionListener {
    ...
    public SalesShoppingCartListIdClickAction(OrderReturnIdInterface prodInterface, JFrame pFrame, javax.swing.JDesktopPane desktopPane, XuiSession session) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (productId != null) {            
            ...
            options.addReturnHeaderType("CUSTOMER_RETURN");
