 ...
 * @author BBS Auctions
 */
public class OrderPaymentInfoScreenlet implements HtmlScreenletInterface {
...
//            "order/webapp/ordermgr/order/orderinfo.ftl"
        File templateFile = new File("C:\\backup\\ofbiz-12.04.02\\applications\\order\\webapp\\ordermgr\\order\\orderpaymentinfo.ftl");
        try {
