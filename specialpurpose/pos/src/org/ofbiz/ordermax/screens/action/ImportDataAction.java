 ...
 * @author siranjeev
 */
public class ImportDataAction extends ScreenAction {

    final String nameStr = "Import Data";
    final String iconPathStr = "clients.png";
    final String iconPathSmallStr = "clients.png";

    public ImportDataAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public ImportDataAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
