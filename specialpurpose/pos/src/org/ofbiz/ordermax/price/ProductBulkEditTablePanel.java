 ...
 */
public class ProductBulkEditTablePanel extends javax.swing.JPanel implements BaseMainPanelInterface {

    static final String module = ProductBulkEditTablePanel.class.getName();
    /**
...
//    protected Map<String, String> departmentValMap = new TreeMap<String, String>();
    ...
    public ProductBulkEditTablePanel(XuiSession session) {
        initComponents();
//        this.priceTreeMap = new PriceTreeMap(session);
  ...
  /*      jTable1 = new RXTable() {
        ...
        /*String facilityId = ControllerOptions.getSession().getProductStore().();
         try {
         ProductStoreGroup facility = ProductStoreGroupSingleton.getProductStoreGroup(facilityId);
         productStoreGroupModel.setSelectedItem(facility);
         } catch (Exception ex) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbDepartmentName, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(cbProductName, 0, 150, Short.MAX_VALUE)
