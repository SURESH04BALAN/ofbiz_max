...
public class FindProductPriceListAction extends ScreenAction {        
    final String nameStr = "Find Product Price List";
    final String iconPathStr = "";//"clients.png";
    final String iconPathSmallStr = "";//"clients.png";
     
    public FindProductPriceListAction(XuiSession session, javax.swing.JDesktopPane desktopPane) {
    ...
    public FindProductPriceListAction(String name, XuiSession session, javax.swing.JDesktopPane desktopPane) {
...
//        }
        ...
        FindProductPriceListController findOrderListMain = new FindProductPriceListController( controllerOptions, session);
    ...
    static class LoadOrderListActionFactory implements ScreenClassFactoryInterface {
        ...
        public ScreenAction createAction(String name, XuiSession session, JDesktopPane desktopPane) {
            return new FindProductPriceListAction(name, session, desktopPane);
        }

               
        @Override
        public ScreenAction createAction(XuiSession session, JDesktopPane desktopPane) {
             return new FindProductPriceListAction(session, desktopPane);
        }
    }
