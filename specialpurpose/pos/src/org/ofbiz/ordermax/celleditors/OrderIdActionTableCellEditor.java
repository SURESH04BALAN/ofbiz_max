 ...
 * @author siranjeev
 */
public class OrderIdActionTableCellEditor extends ActionTableCellEditor {
    ...
    public OrderIdActionTableCellEditor(TableCellEditor editor, java.awt.Frame parent, boolean modal, XuiSession sessionVal) {
        super(editor);
        this.parent = parent;
        this.modal = modal;
