...
/**
 * The OrderMaxTable provides some extensions to the default JTable
 *
 ...
 */
public class OrderMaxTable extends JTable {
...
//
     ...
     * <code>OrderMaxTable</code> that is initialized with a default data model,
     * a default column model, and a default selection model.
     */
    public OrderMaxTable() {
        this(null, null, null);
    }

    /**
     * Constructs a
     * <code>OrderMaxTable</code> that is initialized with
     * <code>dm</code> as the data model, a default column model, and a default
     * selection model.
     *
     * @param dm the data model for the table
     */
    public OrderMaxTable(TableModel dm) {
        this(dm, null, null);
    }
     ...
     */
    public OrderMaxTable(TableModel dm, TableColumnModel cm) {
        this(dm, cm, null);
    }
     ...
     */
    public OrderMaxTable(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
        super(dm, cm, sm);
    }

    /**
     * Constructs a
     * <code>OrderMaxTable</code> with
     ...
     */
    public OrderMaxTable(int numRows, int numColumns) {
        this(new DefaultTableModel(numRows, numColumns));
    }

    /**
     * Constructs a
     * <code>OrderMaxTable</code> to display the values in the
     * <code>Vector</code> of
     * <code>Vectors</code>,
     ...
     */
    public OrderMaxTable(Vector rowData, Vector columnNames) {
        this(new DefaultTableModel(rowData, columnNames));
    }

    /**
     * Constructs a
     * <code>OrderMaxTable</code> to display the values in the two dimensional
     * array,
     * <code>rowData</code>, with column names,
     ...
     * @param columnNames names of each column
     */
    public OrderMaxTable(final Object[][] rowData, final Object[] columnNames) {
...
//
    ...
    private void selectAll(EventObject e) {
        ...
        if (editor == null
            ...
            Debug.logInfo("not Jtext component", "Module" );
            return;
        }
            Debug.logInfo("Jtext component - 1", "Module" );
        if (e == null) {
        ...
        //  Typing in the cell was used to activate the editor
            Debug.logInfo("Jtext component - 2", "Module" );
        ...
        //  F2 was used to activate the editor
            Debug.logInfo("Jtext component - 3", "Module" );
