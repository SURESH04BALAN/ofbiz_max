 ...
 * @author siranjeev
 */
public class CatalogCategoryPickerEditPanel extends BasePickerEditPanel {

    static public String module = CatalogCategoryPickerEditPanel.class.getName();
    public String keyId = "prodCatalogId";

    /**
     * Creates new form DatePickerEditPanel
     */
    public CatalogCategoryPickerEditPanel(final ControllerOptions controllerOptions) {
        super(LookupType.CatalogId, controllerOptions);
        initComponents();
        controllerOptions.put(getEditorId(), textIdField);
        controllerOptions.put("EntityName", "ProdCatalog");
        entityId = "prodCatalogId";
        entityIdDescription = "catalogName";            
...
/*
    public CatalogCategoryPickerEditPanel(final ControllerOptions controllerOptions, JPanel panel) {
    ...
    public void setCatGenericVale(GenericValue genericValue) {
        if (genericValue != null) {
            if (controllerOptions.contains("showData")) {
                jLabel1.setText(genericValue.getString("catalogName"));
