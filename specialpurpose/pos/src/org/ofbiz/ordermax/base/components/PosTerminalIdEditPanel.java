 ...
 * @author siranjeev
 */
public class PosTerminalIdEditPanel extends BasePickerEditPanel {

    static public String module = PosTerminalIdEditPanel.class.getName();
    public String keyId = "posTerminalId";
    /**
     * Creates new form DatePickerEditPanel
     */
    public PosTerminalIdEditPanel(final ControllerOptions controllerOptions) {
        super(LookupType.TerminalId,controllerOptions);
        initComponents();
        controllerOptions.put(getEditorId(), textIdField);
        controllerOptions.put("EntityName", "PosTerminal");
        entityId = "posTerminalId";
        entityIdDescription = "terminalName";          
...
/*
    public PosTerminalIdEditPanel(final ControllerOptions controllerOptions, JPanel panel) {
    ...
    public void setCatGenericVale(GenericValue genericValue) {
        if (genericValue != null) {
            if (controllerOptions.contains("showName")) {
                jLabel1.setText(genericValue.getString("terminalName"));
                textIdField.setText(genericValue.getString("posTerminalId"));
            } else {
                textIdField.setText(genericValue.getString("posTerminalId"));
                jLabel1.setText(genericValue.getString("terminalName"));
            }
