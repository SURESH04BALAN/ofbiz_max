 ...
 * @author siranjeev
 */
public class ProductPickerEditPanel extends javax.swing.JPanel implements ReportParameterSelectionInterface{

    static public String module = ProductPickerEditPanel.class.getName();
    public static String editorId = "ProductIdTextField";
    public String keyId = "productId";
    protected LookupActionListner lookupActionListner = null;
    /**
     * Creates new form DatePickerEditPanel
     */
    public ProductPickerEditPanel(ControllerOptions controllerOptions) {
        initComponents();
        ...
        btnHeaderPatryId.addActionListener(lookupActionListner);
    }

    public ProductPickerEditPanel(ControllerOptions controllerOptions, JPanel panel) {
        initComponents();
        ...
        controllerOptions.put(editorId, textIdField);
        controllerOptions.setDoubleClickCloseDialog();        
//        btnHeaderPatryId.addActionListener(new LookupActionListner(LookupActionListnerInterface.LookupType.ProductId, controllerOptions));
        lookupActionListner = new LookupActionListner(LookupActionListnerInterface.LookupType.ProductId, controllerOptions);
        btnHeaderPatryId.addActionListener(lookupActionListner);        
    }
    ...
    private void initComponents() {
        ...
        btnHeaderPatryId.setIcon(new javax.swing.ImageIcon("C:\\backup\\ofbiz-12.04.02\\productIconsmall.png")); // NOI18N
    ...
    public void addActionListener(ActionListener listener) {
        lookupActionListner.addActionListener(listener);
    }
