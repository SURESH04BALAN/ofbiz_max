 ...
 * @author siranjeev
 */
public class ProdCatalogCategoryEditPanel extends BasePickerEditPanel {

    static public String module = ProdCatalogCategoryEditPanel.class.getName();
    public String keyId = "posTerminalId";
    /**
     * Creates new form DatePickerEditPanel
     */
    public ProdCatalogCategoryEditPanel(final ControllerOptions controllerOptions) {
        super(LookupType.ProdCatalogCategoryId,controllerOptions);
        initComponents();
        controllerOptions.put(getEditorId(), textIdField);
        controllerOptions.put("EntityName", "ProdCatalogCategory");
        entityId = "prodCatalogId";
        entityIdDescription = "productCategoryId";   
...
/*
    public ProdCatalogCategoryEditPanel(final ControllerOptions controllerOptions, JPanel panel) {
...
*/
    ...
    public LookupType getLookupType() {
        return LookupType.ProdCatalogCategoryId;
    }
}
