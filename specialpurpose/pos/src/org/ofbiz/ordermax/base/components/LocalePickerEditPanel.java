 ...
 * @author siranjeev
 */
public class LocalePickerEditPanel extends javax.swing.JPanel {
    
    static public String module = LocalePickerEditPanel.class.getName();
    public static String editorId = "PartyIdTextField";
    /**
     * Creates new form DatePickerEditPanel
     */
    public LocalePickerEditPanel(ControllerOptions controllerOptions) {
        initComponents();
   ...
   public LocalePickerEditPanel(ControllerOptions controllerOptions, JPanel panel) {
        initComponents();
