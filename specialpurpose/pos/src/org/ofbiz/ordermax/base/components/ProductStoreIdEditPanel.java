 ...
 * @author siranjeev
 */
public class ProductStoreIdEditPanel extends BasePickerEditPanel {

    static public String module = ProductStoreIdEditPanel.class.getName();
    public String keyId = "productStoreId";

    /**
     * Creates new form DatePickerEditPanel
     */
    public ProductStoreIdEditPanel(final ControllerOptions controllerOptions) {
        super(LookupType.ProductStoreId,controllerOptions);
        initComponents();
        controllerOptions.put(getEditorId(), textIdField);
        controllerOptions.put("EntityName", "ProductStore");
        entityId = "productStoreId";
        entityIdDescription = "storeName";          
...
/*
    public ProductStoreIdEditPanel(final ControllerOptions controllerOptions, JPanel panel) {
    ...
    public void setCatGenericVale(GenericValue genericValue) {
        if (genericValue != null) {
            if (controllerOptions.contains("showName")) {
                jLabel1.setText(genericValue.getString("storeName"));
...
*/
    ...
    public LookupType getLookupType() {
        return LookupType.ProductStoreId;
    }
}
