...
public class PartyQualType implements GenericValueObjectInterface {
public static final String module =PartyQualType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public PartyQualType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"partyQualTypeId","Party Qual Type Id"},
...
this.partyQualTypeId = (java.lang.String) genVal.get("partyQualTypeId");
...
val.set("partyQualTypeId",OrderMaxUtility.getValidEntityString(this.partyQualTypeId));
...
valueMap.put("partyQualTypeId",this.partyQualTypeId);
return valueMap;
}
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("PartyQualType");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String partyQualTypeId;
public java.lang.String getpartyQualTypeId() {
return partyQualTypeId;
}
public void setpartyQualTypeId( java.lang.String partyQualTypeId ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<PartyQualType> objectList = new ArrayList<PartyQualType>();
        for (GenericValue genVal : genList) {
            objectList.add(new PartyQualType(genVal));
        }
        return objectList;
    }    
}
