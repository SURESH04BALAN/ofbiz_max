...
public class GoodIdentificationAndProduct implements GenericValueObjectInterface {
public static final String module =GoodIdentificationAndProduct.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public GoodIdentificationAndProduct(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("GoodIdentificationAndProduct");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<GoodIdentificationAndProduct> objectList = new ArrayList<GoodIdentificationAndProduct>();
        for (GenericValue genVal : genList) {
            objectList.add(new GoodIdentificationAndProduct(genVal));
        }
        return objectList;
    }    
}
