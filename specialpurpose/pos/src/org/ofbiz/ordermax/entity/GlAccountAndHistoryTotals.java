...
public class GlAccountAndHistoryTotals implements GenericValueObjectInterface {
public static final String module =GlAccountAndHistoryTotals.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public GlAccountAndHistoryTotals(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
public GlAccountAndHistoryTotals () {
initObject();
}
...
{"totalPostedDebits","Total Posted Debits"},
{"customTimePeriodId","Custom Time Period Id"},
{"totalPostedCredits","Total Posted Credits"},
};
...
this.totalPostedDebits = java.math.BigDecimal.ZERO;
this.customTimePeriodId = "";
this.totalPostedCredits = java.math.BigDecimal.ZERO;
}
...
this.totalEndingBalance = (java.lang.String) genVal.get("totalEndingBalance");
...
this.totalPostedDebits = (java.math.BigDecimal) genVal.get("totalPostedDebits");
this.customTimePeriodId = (java.lang.String) genVal.get("customTimePeriodId");
this.totalPostedCredits = (java.math.BigDecimal) genVal.get("totalPostedCredits");
}
...
val.set("totalEndingBalance",OrderMaxUtility.getValidEntityString(this.totalEndingBalance));
...
val.set("totalPostedDebits",OrderMaxUtility.getValidEntityBigDecimal(this.totalPostedDebits));
val.set("customTimePeriodId",OrderMaxUtility.getValidEntityString(this.customTimePeriodId));
val.set("totalPostedCredits",OrderMaxUtility.getValidEntityBigDecimal(this.totalPostedCredits));
}
...
valueMap.put("totalEndingBalance",this.totalEndingBalance);
...
valueMap.put("totalPostedDebits",this.totalPostedDebits);
valueMap.put("customTimePeriodId",this.customTimePeriodId);
valueMap.put("totalPostedCredits",this.totalPostedCredits);
return valueMap;
}
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("GlAccountAndHistoryTotals");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String totalEndingBalance;
public java.lang.String gettotalEndingBalance() {
return totalEndingBalance;
}
public void settotalEndingBalance( java.lang.String totalEndingBalance ) {
...
private java.math.BigDecimal totalPostedDebits;
public java.math.BigDecimal gettotalPostedDebits() {
return totalPostedDebits;
}
public void settotalPostedDebits( java.math.BigDecimal totalPostedDebits ) {
this.totalPostedDebits = totalPostedDebits;
}
...
private java.math.BigDecimal totalPostedCredits;
public java.math.BigDecimal gettotalPostedCredits() {
return totalPostedCredits;
}
public void settotalPostedCredits( java.math.BigDecimal totalPostedCredits ) {
this.totalPostedCredits = totalPostedCredits;
}
@Override
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<GlAccountAndHistoryTotals> objectList = new ArrayList<GlAccountAndHistoryTotals>();
        for (GenericValue genVal : genList) {
            objectList.add(new GlAccountAndHistoryTotals(genVal));
        }
        return objectList;
    }    
}
