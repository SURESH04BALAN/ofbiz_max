...
public class TerminationType implements GenericValueObjectInterface {
public static final String module =TerminationType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public TerminationType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"terminationTypeId","Termination Type Id"},
...
this.terminationTypeId = (java.lang.String) genVal.get("terminationTypeId");
...
val.set("terminationTypeId",OrderMaxUtility.getValidEntityString(this.terminationTypeId));
...
valueMap.put("terminationTypeId",this.terminationTypeId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("TerminationType");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<TerminationType> objectList = new ArrayList<TerminationType>();
        for (GenericValue genVal : genList) {
            objectList.add(new TerminationType(genVal));
        }
        return objectList;
    }    
}
