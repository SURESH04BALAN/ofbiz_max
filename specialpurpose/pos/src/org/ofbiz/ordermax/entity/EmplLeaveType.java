...
public class EmplLeaveType implements GenericValueObjectInterface {
public static final String module =EmplLeaveType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public EmplLeaveType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
this.leaveTypeId = (java.lang.String) genVal.get("leaveTypeId");
...
val.set("leaveTypeId",OrderMaxUtility.getValidEntityString(this.leaveTypeId));
...
valueMap.put("leaveTypeId",this.leaveTypeId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("EmplLeaveType");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String leaveTypeId;
public java.lang.String getleaveTypeId() {
return leaveTypeId;
}
public void setleaveTypeId( java.lang.String leaveTypeId ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<EmplLeaveType> objectList = new ArrayList<EmplLeaveType>();
        for (GenericValue genVal : genList) {
            objectList.add(new EmplLeaveType(genVal));
        }
        return objectList;
    }    
}
