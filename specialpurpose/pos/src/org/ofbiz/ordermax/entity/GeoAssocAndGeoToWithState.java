...
public class GeoAssocAndGeoToWithState implements GenericValueObjectInterface {
public static final String module =GeoAssocAndGeoToWithState.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public GeoAssocAndGeoToWithState(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
public GeoAssocAndGeoToWithState () {
initObject();
}
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("GeoAssocAndGeoToWithState");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<GeoAssocAndGeoToWithState> objectList = new ArrayList<GeoAssocAndGeoToWithState>();
        for (GenericValue genVal : genList) {
            objectList.add(new GeoAssocAndGeoToWithState(genVal));
        }
        return objectList;
    }    
}
