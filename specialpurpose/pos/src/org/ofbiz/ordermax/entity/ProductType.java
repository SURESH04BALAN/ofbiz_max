...
public class ProductType implements GenericValueObjectInterface , DisplayNameInterface{

    public static final String module = ProductType.class.getName();
    public static int COL_SIZE = 80;
    final static String Default_Cell_Rendere = "DEFAULT";
    final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
    private GenericValue genVal = null;

    public ProductType(GenericValue val) {
        genVal = val;
        try {
            setGenericValue();
        } catch (Exception ex) {
    ...
    public void setGenericValue() throws Exception {
        ...
        this.isDigital = (java.lang.String) genVal.get("isDigital");
        this.isPhysical = (java.lang.String) genVal.get("isPhysical");
    ...
    protected void getGenericValue(GenericValue val) {
        ...
        val.set("isDigital", OrderMaxUtility.getValidEntityString(this.isDigital));
        val.set("isPhysical", OrderMaxUtility.getValidEntityString(this.isPhysical));
    ...
    public Map<String, Object> getValuesMap() {
        ...
        valueMap.put("isDigital", this.isDigital);
        valueMap.put("isPhysical", this.isPhysical);
        return valueMap;
    }
    ...
    public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator) {
        genVal = delegator.makeValue("ProductType");
        getGenericValue(genVal);
        return genVal;
    }
    ...
    private java.lang.String isDigital;

    public java.lang.String getisDigital() {
        return isDigital;
    }

    public void setisDigital(java.lang.String isDigital) {
        this.isDigital = isDigital;
    }
    private java.lang.String isPhysical;

    public java.lang.String getisPhysical() {
        return isPhysical;
    }

    public void setisPhysical(java.lang.String isPhysical) {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<ProductType> objectList = new ArrayList<ProductType>();
        for (GenericValue genVal : genList) {
            objectList.add(new ProductType(genVal));
        }
        return objectList;
    }
 ...
 StringBuilder orderToStringBuilder = new StringBuilder();
        if (DisplayNameInterface.DisplayTypes.SHOW_NAME_AND_CODE.equals(showId) || DisplayNameInterface.DisplayTypes.SHOW_NAME_ONLY.equals(showId)) {
            ...
            if (DisplayNameInterface.DisplayTypes.SHOW_NAME_AND_CODE.equals(showId)) {
                ...
                orderToStringBuilder.append(getproductTypeId());
                orderToStringBuilder.append(" ]");
            }
        } else {
            orderToStringBuilder.append(getproductTypeId());
