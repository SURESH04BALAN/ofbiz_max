...
public class PartyRoleAndPartyDetail implements GenericValueObjectInterface {
public static final String module =PartyRoleAndPartyDetail.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public PartyRoleAndPartyDetail(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
this.previousStatusId = (java.lang.String) genVal.get("previousStatusId");
...
val.set("previousStatusId",OrderMaxUtility.getValidEntityString(this.previousStatusId));
...
valueMap.put("previousStatusId",this.previousStatusId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("PartyRoleAndPartyDetail");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String previousStatusId;
public java.lang.String getpreviousStatusId() {
return previousStatusId;
}
public void setpreviousStatusId( java.lang.String previousStatusId ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<PartyRoleAndPartyDetail> objectList = new ArrayList<PartyRoleAndPartyDetail>();
        for (GenericValue genVal : genList) {
            objectList.add(new PartyRoleAndPartyDetail(genVal));
        }
        return objectList;
    }    
}
