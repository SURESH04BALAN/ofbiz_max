...
public class InvoiceItemProductSummariesWithOrderId implements GenericValueObjectInterface {

    public static final String module = InvoiceItemProductSummariesWithOrderId.class.getName();
    public static int COL_SIZE = 80;
    final static String Default_Cell_Rendere = "DEFAULT";
    final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
    private GenericValue genVal = null;

    public InvoiceItemProductSummariesWithOrderId(GenericValue val) {
        genVal = val;
        try {
            setGenericValue();
        } catch (Exception ex) {
//Debug.logInfo(ex, module);
    ...
    public InvoiceItemProductSummariesWithOrderId() {
        initObject();
    }
    ...
    public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator) {
        genVal = delegator.makeValue("InvoiceItemProductSummariesWithOrderId");
        getGenericValue(genVal);
        return genVal;
    }
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<InvoiceItemProductSummariesWithOrderId> objectList = new ArrayList<InvoiceItemProductSummariesWithOrderId>();
        for (GenericValue genVal : genList) {
            objectList.add(new InvoiceItemProductSummariesWithOrderId(genVal));
        }
        return objectList;
    }
}
