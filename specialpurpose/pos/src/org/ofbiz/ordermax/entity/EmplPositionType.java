...
public class EmplPositionType implements GenericValueObjectInterface {
public static final String module =EmplPositionType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public EmplPositionType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"emplPositionTypeId","Empl Position Type Id"},
...
this.emplPositionTypeId = (java.lang.String) genVal.get("emplPositionTypeId");
...
val.set("emplPositionTypeId",OrderMaxUtility.getValidEntityString(this.emplPositionTypeId));
...
valueMap.put("emplPositionTypeId",this.emplPositionTypeId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("EmplPositionType");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<EmplPositionType> objectList = new ArrayList<EmplPositionType>();
        for (GenericValue genVal : genList) {
            objectList.add(new EmplPositionType(genVal));
        }
        return objectList;
    }    
}
