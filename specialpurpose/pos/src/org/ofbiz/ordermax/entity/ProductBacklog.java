...
public class ProductBacklog implements GenericValueObjectInterface {
public static final String module =ProductBacklog.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public ProductBacklog(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"reason","Reason"},
{"workEffortStatusId","Work Effort Status Id"},
{"statusId","Status Id"},
...
{"parentCustRequestName","Parent Cust Request Name"},
...
this.workEffortStatusId = (java.lang.String) genVal.get("workEffortStatusId");
...
this.parentCustRequestName = (java.lang.String) genVal.get("parentCustRequestName");
...
val.set("workEffortStatusId",OrderMaxUtility.getValidEntityString(this.workEffortStatusId));
...
val.set("parentCustRequestName",OrderMaxUtility.getValidEntityString(this.parentCustRequestName));
...
valueMap.put("workEffortStatusId",this.workEffortStatusId);
...
valueMap.put("parentCustRequestName",this.parentCustRequestName);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("ProductBacklog");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String workEffortStatusId;
public java.lang.String getworkEffortStatusId() {
return workEffortStatusId;
}
public void setworkEffortStatusId( java.lang.String workEffortStatusId ) {
this.workEffortStatusId = workEffortStatusId;
}
...
private java.lang.String parentCustRequestName;
public java.lang.String getparentCustRequestName() {
return parentCustRequestName;
}
public void setparentCustRequestName( java.lang.String parentCustRequestName ) {
this.parentCustRequestName = parentCustRequestName;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<ProductBacklog> objectList = new ArrayList<ProductBacklog>();
        for (GenericValue genVal : genList) {
            objectList.add(new ProductBacklog(genVal));
        }
        return objectList;
    }    
}
