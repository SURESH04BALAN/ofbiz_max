...
public class InvoiceAndRole implements GenericValueObjectInterface {
public static final String module =InvoiceAndRole.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public InvoiceAndRole(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"invoiceRoleTypeId","Invoice Role Type Id"},
...
{"statusId","Status Id"},
{"invoiceRolePartyId","Invoice Role Party Id"},
...
this.invoiceRoleTypeId = (java.lang.String) genVal.get("invoiceRoleTypeId");
...
this.invoiceRolePartyId = (java.lang.String) genVal.get("invoiceRolePartyId");
...
val.set("invoiceRoleTypeId",OrderMaxUtility.getValidEntityString(this.invoiceRoleTypeId));
...
val.set("invoiceRolePartyId",OrderMaxUtility.getValidEntityString(this.invoiceRolePartyId));
...
valueMap.put("invoiceRoleTypeId",this.invoiceRoleTypeId);
...
valueMap.put("invoiceRolePartyId",this.invoiceRolePartyId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("InvoiceAndRole");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String invoiceRoleTypeId;
public java.lang.String getinvoiceRoleTypeId() {
return invoiceRoleTypeId;
}
public void setinvoiceRoleTypeId( java.lang.String invoiceRoleTypeId ) {
this.invoiceRoleTypeId = invoiceRoleTypeId;
}
...
private java.lang.String invoiceRolePartyId;
public java.lang.String getinvoiceRolePartyId() {
return invoiceRolePartyId;
}
public void setinvoiceRolePartyId( java.lang.String invoiceRolePartyId ) {
this.invoiceRolePartyId = invoiceRolePartyId;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<InvoiceAndRole> objectList = new ArrayList<InvoiceAndRole>();
        for (GenericValue genVal : genList) {
            objectList.add(new InvoiceAndRole(genVal));
        }
        return objectList;
    }    
}
