...
public class FixedAssetType implements GenericValueObjectInterface {
public static final String module =FixedAssetType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public FixedAssetType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"fixedAssetTypeId","Fixed Asset Type Id"},
...
this.fixedAssetTypeId = (java.lang.String) genVal.get("fixedAssetTypeId");
...
val.set("fixedAssetTypeId",OrderMaxUtility.getValidEntityString(this.fixedAssetTypeId));
...
valueMap.put("fixedAssetTypeId",this.fixedAssetTypeId);
return valueMap;
}
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("FixedAssetType");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String fixedAssetTypeId;
public java.lang.String getfixedAssetTypeId() {
return fixedAssetTypeId;
}
public void setfixedAssetTypeId( java.lang.String fixedAssetTypeId ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<FixedAssetType> objectList = new ArrayList<FixedAssetType>();
        for (GenericValue genVal : genList) {
            objectList.add(new FixedAssetType(genVal));
        }
        return objectList;
    }    
}
