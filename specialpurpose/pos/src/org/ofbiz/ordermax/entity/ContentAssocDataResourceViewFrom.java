...
public class ContentAssocDataResourceViewFrom implements GenericValueObjectInterface {
public static final String module =ContentAssocDataResourceViewFrom.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public ContentAssocDataResourceViewFrom(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("ContentAssocDataResourceViewFrom");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<ContentAssocDataResourceViewFrom> objectList = new ArrayList<ContentAssocDataResourceViewFrom>();
        for (GenericValue genVal : genList) {
            objectList.add(new ContentAssocDataResourceViewFrom(genVal));
        }
        return objectList;
    }    
}
