...
public class AgreementType implements GenericValueObjectInterface {
public static final String module =AgreementType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public AgreementType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
this.agreementTypeId = (java.lang.String) genVal.get("agreementTypeId");
...
val.set("agreementTypeId",OrderMaxUtility.getValidEntityString(this.agreementTypeId));
...
valueMap.put("agreementTypeId",this.agreementTypeId);
return valueMap;
}
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("AgreementType");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String agreementTypeId;
public java.lang.String getagreementTypeId() {
return agreementTypeId;
}
public void setagreementTypeId( java.lang.String agreementTypeId ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<AgreementType> objectList = new ArrayList<AgreementType>();
        for (GenericValue genVal : genList) {
            objectList.add(new AgreementType(genVal));
        }
        return objectList;
    }    
}
