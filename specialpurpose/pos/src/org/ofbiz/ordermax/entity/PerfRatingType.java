...
public class PerfRatingType implements GenericValueObjectInterface {
public static final String module =PerfRatingType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public PerfRatingType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"perfRatingTypeId","Perf Rating Type Id"},
...
this.perfRatingTypeId = (java.lang.String) genVal.get("perfRatingTypeId");
...
val.set("perfRatingTypeId",OrderMaxUtility.getValidEntityString(this.perfRatingTypeId));
...
valueMap.put("perfRatingTypeId",this.perfRatingTypeId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("PerfRatingType");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String perfRatingTypeId;
public java.lang.String getperfRatingTypeId() {
return perfRatingTypeId;
}
public void setperfRatingTypeId( java.lang.String perfRatingTypeId ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<PerfRatingType> objectList = new ArrayList<PerfRatingType>();
        for (GenericValue genVal : genList) {
            objectList.add(new PerfRatingType(genVal));
        }
        return objectList;
    }    
}
