...
public class CustRequestAndCustRequestItem implements GenericValueObjectInterface {
public static final String module =CustRequestAndCustRequestItem.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public CustRequestAndCustRequestItem(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
public CustRequestAndCustRequestItem () {
initObject();
}
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("CustRequestAndCustRequestItem");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<CustRequestAndCustRequestItem> objectList = new ArrayList<CustRequestAndCustRequestItem>();
        for (GenericValue genVal : genList) {
            objectList.add(new CustRequestAndCustRequestItem(genVal));
        }
        return objectList;
    }    
}
