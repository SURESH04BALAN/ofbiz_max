...
public class DocumentType implements GenericValueObjectInterface {
public static final String module =DocumentType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public DocumentType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
this.documentTypeId = (java.lang.String) genVal.get("documentTypeId");
...
val.set("documentTypeId",OrderMaxUtility.getValidEntityString(this.documentTypeId));
...
valueMap.put("documentTypeId",this.documentTypeId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("DocumentType");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<DocumentType> objectList = new ArrayList<DocumentType>();
        for (GenericValue genVal : genList) {
            objectList.add(new DocumentType(genVal));
        }
        return objectList;
    }    
}
