...
public class ElectronicText implements GenericValueObjectInterface {
public static final String module =ElectronicText.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public ElectronicText(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
this.textData = (java.lang.String) genVal.get("textData");
...
val.set("textData",OrderMaxUtility.getValidEntityString(this.textData));
val.set("lastUpdatedTxStamp",OrderMaxUtility.getValidEntityTimestamp(this.lastUpdatedTxStamp));
}
public Map<String, Object> getValuesMap() {
Map<String, Object> valueMap = new HashMap<String,Object>();
valueMap.put("dataResourceId",this.dataResourceId);
valueMap.put("textData",this.textData);
return valueMap;
}
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("ElectronicText");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<ElectronicText> objectList = new ArrayList<ElectronicText>();
        for (GenericValue genVal : genList) {
            objectList.add(new ElectronicText(genVal));
        }
        return objectList;
    }    
}
