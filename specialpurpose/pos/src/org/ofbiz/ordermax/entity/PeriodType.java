...
public class PeriodType implements GenericValueObjectInterface {
public static final String module =PeriodType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public PeriodType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
this.periodLength = (java.lang.Long) genVal.get("periodLength");
...
val.set("periodLength",this.periodLength);
...
valueMap.put("periodLength",this.periodLength);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("PeriodType");
        getGenericValue(genVal);
return genVal;
}
...
public void setperiodLength( java.lang.Long periodLength ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<PeriodType> objectList = new ArrayList<PeriodType>();
        for (GenericValue genVal : genList) {
            objectList.add(new PeriodType(genVal));
        }
        return objectList;
    }    
}
