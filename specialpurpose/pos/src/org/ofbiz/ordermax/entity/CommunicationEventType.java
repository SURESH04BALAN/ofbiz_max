...
public class CommunicationEventType implements GenericValueObjectInterface {
public static final String module =CommunicationEventType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public CommunicationEventType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"communicationEventTypeId","Communication Event Type Id"},
...
this.communicationEventTypeId = (java.lang.String) genVal.get("communicationEventTypeId");
...
val.set("communicationEventTypeId",OrderMaxUtility.getValidEntityString(this.communicationEventTypeId));
...
valueMap.put("communicationEventTypeId",this.communicationEventTypeId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("CommunicationEventType");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String communicationEventTypeId;
public java.lang.String getcommunicationEventTypeId() {
return communicationEventTypeId;
}
public void setcommunicationEventTypeId( java.lang.String communicationEventTypeId ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<CommunicationEventType> objectList = new ArrayList<CommunicationEventType>();
        for (GenericValue genVal : genList) {
            objectList.add(new CommunicationEventType(genVal));
        }
        return objectList;
    }    
}
