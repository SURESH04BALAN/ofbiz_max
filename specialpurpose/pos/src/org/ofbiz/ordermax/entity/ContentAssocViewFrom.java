...
public class ContentAssocViewFrom implements GenericValueObjectInterface {
public static final String module =ContentAssocViewFrom.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public ContentAssocViewFrom(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("ContentAssocViewFrom");
        getGenericValue(genVal);
return genVal;
}
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<ContentAssocViewFrom> objectList = new ArrayList<ContentAssocViewFrom>();
        for (GenericValue genVal : genList) {
            objectList.add(new ContentAssocViewFrom(genVal));
        }
        return objectList;
    }    
}
