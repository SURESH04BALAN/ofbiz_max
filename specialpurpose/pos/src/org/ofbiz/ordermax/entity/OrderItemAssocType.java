...
public class OrderItemAssocType implements GenericValueObjectInterface {
public static final String module =OrderItemAssocType.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public OrderItemAssocType(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
{"orderItemAssocTypeId","Order Item Assoc Type Id"},
...
this.orderItemAssocTypeId = (java.lang.String) genVal.get("orderItemAssocTypeId");
...
val.set("orderItemAssocTypeId",OrderMaxUtility.getValidEntityString(this.orderItemAssocTypeId));
...
valueMap.put("orderItemAssocTypeId",this.orderItemAssocTypeId);
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("OrderItemAssocType");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.String orderItemAssocTypeId;
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<OrderItemAssocType> objectList = new ArrayList<OrderItemAssocType>();
        for (GenericValue genVal : genList) {
            objectList.add(new OrderItemAssocType(genVal));
        }
        return objectList;
    }    
}
