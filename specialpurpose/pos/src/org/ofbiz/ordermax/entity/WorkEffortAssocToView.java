...
public class WorkEffortAssocToView implements GenericValueObjectInterface {
public static final String module =WorkEffortAssocToView.class.getName();
public static int COL_SIZE = 80;
final static String Default_Cell_Rendere = "DEFAULT";
final static String GenericValue_Cell_Renderer = "GENERIC_VALUE";
private GenericValue genVal = null;
public WorkEffortAssocToView(GenericValue val){
genVal =  val;
try {
setGenericValue();
} catch (Exception ex) {
...
this.estimatedSetupMillis = new Double(0);
this.lastStatusUpdate = "";
this.createdDate = UtilDateTime.nowTimestamp();
this.estimatedMilliSeconds = new Double(0);
this.tempExprId = "";
...
this.estimatedSetupMillis = (java.lang.Double) genVal.get("estimatedSetupMillis");
...
this.estimatedMilliSeconds = (java.lang.Double) genVal.get("estimatedMilliSeconds");
...
this.quantityToProduce = (java.lang.String) genVal.get("quantityToProduce");
...
val.set("estimatedSetupMillis",OrderMaxUtility.getValidEntityDouble(this.estimatedSetupMillis));
...
val.set("estimatedMilliSeconds",OrderMaxUtility.getValidEntityDouble(this.estimatedMilliSeconds));
...
val.set("quantityToProduce",OrderMaxUtility.getValidEntityString(this.quantityToProduce));
...
public org.ofbiz.entity.GenericValue createNewGenericValueObj(org.ofbiz.entity.Delegator delegator){
 genVal = delegator.makeValue("WorkEffortAssocToView");
        getGenericValue(genVal);
return genVal;
}
...
private java.lang.Double estimatedSetupMillis;
public java.lang.Double getestimatedSetupMillis() {
return estimatedSetupMillis;
}
public void setestimatedSetupMillis( java.lang.Double estimatedSetupMillis ) {
...
private java.lang.Double estimatedMilliSeconds;
public java.lang.Double getestimatedMilliSeconds() {
return estimatedMilliSeconds;
}
public void setestimatedMilliSeconds( java.lang.Double estimatedMilliSeconds ) {
...
private java.lang.String quantityToProduce;
public java.lang.String getquantityToProduce() {
return quantityToProduce;
}
public void setquantityToProduce( java.lang.String quantityToProduce ) {
...
public String[][] getColumnNameId() {
    ...
    public Collection getObjectList(List<org.ofbiz.entity.GenericValue> genList) {
        Collection<WorkEffortAssocToView> objectList = new ArrayList<WorkEffortAssocToView>();
        for (GenericValue genVal : genList) {
            objectList.add(new WorkEffortAssocToView(genVal));
        }
        return objectList;
    }    
}
