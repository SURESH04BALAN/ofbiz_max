 ...
 * @author siranjeev
 */
public class OrderSummaryListPanel extends javax.swing.JPanel {
...
//    private ListAdapterListModel<InvoiceComposite> invoiceCompositeListModel = new ListAdapterListModel<InvoiceComposite>();
     ...
     */
    public OrderSummaryListPanel(ControllerOptions options) {
        initComponents();
        ...
        ComponentBorder.doubleRaisedLoweredBevelBorder(panelIResultList, "Order List");
    }
