 ...
 * @author siranjeev
 */
public class NewCustomerPaymentSummaryAgeingReportJasper extends NewSupplierAgeingReport {

//        static {
//     ReportBaseFactory.registerReport(new InvoiceReportJasper());
//     }
    public static final String module = NewCustomerPaymentSummaryAgeingReportJasper.class.getName();
...
//        org.ofbiz.ordermax.Dates.Month curMonth = new org.ofbiz.ordermax.Dates.Month();
            ...
            param.put("CURRENTEOM", curMonth.getEnd());
                        Debug.logInfo(" CURRENTEOM: " + curMonth.getEnd(), module);
            ...
            param.put("LAST30EOM", lastMonth.getEnd());
                        Debug.logInfo(" LAST30EOM: " + lastMonth.getEnd(), module);            
            ...
            param.put("LAST60EOM", last60Month.getEnd());
                        Debug.logInfo(" LAST60EOM: " + last60Month.getEnd(), module);             
            ...
            param.put("LAST90EOM", last90Month.getEnd());
                        Debug.logInfo(" LAST90EOM: " + last90Month.getEnd(), module);              
