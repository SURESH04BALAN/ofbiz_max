 ...
 * @author siranjeev
 */
public class NewSupplierAgeingReport extends NewEntityJasperReport {

    public static final String module = NewSupplierAgeingReport.class.getName();
    /*    static {
...
//        List<EntityCondition> condList = getWhereClauseCond();
    ...
    protected String currentDate = "currentDate";
    /*@Override
    ...
    */
    @Override
      public void loadParameterSelections() {
        ...
        com.openbravo.pos.reports.params.JParamHelper.AddReportDateSelection(getQbffilter(), options, "Date Selection", currentDate);        
    }   
//    getInvoicePaymentInfoListByDueDateOffset
    ...
    public Collection getBeanCollection(Map<String, Object> collectionMap) throws Exception {
        ...
        if (UtilValidate.isNotEmpty(invoiceTypeId)) {
            result = loadInvoice(invoiceTypeId, ControllerOptions.getSession());
        } else {
            throw new Exception("Invalid invoice type  id: " + invoiceTypeId);
        }
    ...
    static public class PaymentAgeingReportData {
        ...
        public void setPartyNameView(PartyNameView val) {
            ...
            Debug.logInfo("partyToFirstName : " +partyToFirstName + " partyToGroupName:" + partyToGroupName + " --- partyToLastName  --- " + partyToLastName, module);
            ...
            if (resultMap.containsKey("invoicePaymentInfoList")) {
                ...
                for (javolution.util.FastMap<String, Object> gv : invoiceItems) {
                    ...
                    try {
                        ...
                        Debug.logInfo("setOutstandingAmount : " +repData.outstandingAmount + " partyTypeId:" + repData.partyTypeId + " --- repData.partyToFirstName  --- " + repData.partyToFirstName + " --- partyNameView.getlastName() " + repData.partyToLastName+  " --- repData.gropNamr() " + repData.partyToGroupName, module);
