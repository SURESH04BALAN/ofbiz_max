 ...
 * @author siranjeev
 */
public class SalesInvoiceReportJasper extends EntityJasperReport implements ReportInterface {

//        static {
//     ReportBaseFactory.registerReport(new InvoiceReportJasper());
//     }
    public static final String module = SalesInvoiceReportJasper.class.getName();
...
//        return super.getReportPanel(jasperPrint);
    ...
    void loadInvoiceAmounts() {
        ...
        data.invoiceId = "CI6";
        data.newInvoiceId = "50002";
        data.invoiceAmount = BigDecimal.ZERO;
        data.balanceAmount = BigDecimal.ZERO;
