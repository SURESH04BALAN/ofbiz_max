 ...
 * @author siranjeev
 */
public class NewCustomerPaymentReportJasper extends NewEntityJasperReport {

//        static {
//     ReportBaseFactory.registerReport(new InvoiceReportJasper());
//     }
    public static final String module = NewCustomerPaymentReportJasper.class.getName();
