 ...
 * @author siranjeev
 */
public class EndOfTheDayReportPanel1 extends javax.swing.JPanel {

    static public String Name = "End Of the day";
    public static final String module = EndOfTheDayReportPanel1.class.getName();

    /**
     * Creates new form EndOfTheDayReportPanel
     */
    public EndOfTheDayReportPanel1() {
        initComponents();
    }
