...
public class ModelessDialogFrame extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                //create GUI frame
                new ModelessDialogFrame().setVisible(true);
            }
        });

    }

    public ModelessDialogFrame() {
        ...
        dialog = new JDialog(this, "Click a button");
        ...
        JLabel dialogLabel = new JLabel("Click OK to see the other"
                + 
