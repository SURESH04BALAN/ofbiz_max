            ...
            if (UtilValidate.isNotEmpty(person)) {
                ...
                if (UtilValidate.isNotEmpty(cardId)) {
                    ...
                    if (UtilValidate.isEmpty(result)) {
                        ...
                        m_pos.showMessageDialog("dialog/error/exception", result);
                    }
                }
            }
        }
    ...
    public synchronized void edit(String editType) {
        if (wasMouseClicked()) {
            ...
            if (UtilValidate.isNotEmpty(name)) {
                ...
                m_pos.showMessageDialog("dialog/error/exception", UtilProperties.getMessage(PosTransaction.resource, "PosFieldsRequired", locale));
            }
        }
    }
