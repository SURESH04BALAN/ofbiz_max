...
import org.ofbiz.pos.pospanel.CustomerDisplayData;
...
public class PosTransaction implements Serializable {
    ...
    private Stack<String> groceryKeyMap = new Stack<String>();
    private Stack<String> scaleKeyMap = new Stack<String>();    
...
//        this.locale = (Locale) session.getAttribute("locale"); This is legacy code and may come (demo) from ProductStore.defaultLocaleString defined in demoRetail and is incompatible with how localisation is handled in the POS
    ...
    /*
     private void addGroceryKeyMap() {
     groceryKeyMap = new Stack<String>();
     groceryKeyMap.push("GT6163");
     groceryKeyMap.push("GT6145");
     groceryKeyMap.push("GT6128");
     groceryKeyMap.push("GT6112");
     groceryKeyMap.push("GT6097");
     groceryKeyMap.push("GT6083");
     groceryKeyMap.push("GT6070");
     groceryKeyMap.push("GT6058");
     groceryKeyMap.push("GT6047");
     groceryKeyMap.push("GT6037");
     groceryKeyMap.push("GT6028");
     groceryKeyMap.push("GT6020");
     groceryKeyMap.push("GT6012");
     groceryKeyMap.push("GT6005");
     groceryKeyMap.push("GT6004");
     }
     */
    private void addScaleKeyMap() {
        scaleKeyMap = new Stack<String>();
        scaleKeyMap = new Stack<String>();
        for (int i = 200; i >= 0; --i) {
            String val = "ST6" + String.format("%03d", i);
            scaleKeyMap.push(val);
        }
    }
    ...
    private void addGroceryKeyMap() {
        ...
        for (int i = 200; i >= 0; --i) {
            ...
            groceryKeyMap.push(val);
        }

        /*groceryKeyMap.push("GT6060");
         groceryKeyMap.push("GT6059");
         groceryKeyMap.push("GT6058");
         groceryKeyMap.push("GT6057");
         groceryKeyMap.push("GT6056");
         groceryKeyMap.push("GT6055");
         groceryKeyMap.push("GT6054");
         groceryKeyMap.push("GT6053");
         groceryKeyMap.push("GT6052");
         groceryKeyMap.push("GT6051");
         groceryKeyMap.push("GT6050");
         groceryKeyMap.push("GT6049");
         groceryKeyMap.push("GT6048");
         groceryKeyMap.push("GT6047");
         groceryKeyMap.push("GT6046");
         groceryKeyMap.push("GT6045");
         groceryKeyMap.push("GT6044");
         groceryKeyMap.push("GT6043");
         groceryKeyMap.push("GT6042");
         groceryKeyMap.push("GT6041");
         groceryKeyMap.push("GT6040");
         groceryKeyMap.push("GT6039");
         groceryKeyMap.push("GT6038");
         groceryKeyMap.push("GT6037");
         groceryKeyMap.push("GT6036");
         groceryKeyMap.push("GT6035");
         groceryKeyMap.push("GT6034");
         groceryKeyMap.push("GT6033");
         groceryKeyMap.push("GT6032");
         groceryKeyMap.push("GT6031");        
         groceryKeyMap.push("GT6030");
         groceryKeyMap.push("GT6029");
         groceryKeyMap.push("GT6028");
         groceryKeyMap.push("GT6027");
         groceryKeyMap.push("GT6026");
         groceryKeyMap.push("GT6025");
         groceryKeyMap.push("GT6024");
         groceryKeyMap.push("GT6023");
         groceryKeyMap.push("GT6022");
         groceryKeyMap.push("GT6021");
         groceryKeyMap.push("GT6020");
         groceryKeyMap.push("GT6019");
         groceryKeyMap.push("GT6018");
         groceryKeyMap.push("GT6017");
         groceryKeyMap.push("GT6016");
         groceryKeyMap.push("GT6015");
         groceryKeyMap.push("GT6014");
         groceryKeyMap.push("GT6013");
         groceryKeyMap.push("GT6012");
         groceryKeyMap.push("GT6011");
         groceryKeyMap.push("GT6010");
         groceryKeyMap.push("GT6009");
         groceryKeyMap.push("GT6008");
         groceryKeyMap.push("GT6007");
         groceryKeyMap.push("GT6006");
         groceryKeyMap.push("GT6005");
         groceryKeyMap.push("GT6004");
         groceryKeyMap.push("GT6003");
         groceryKeyMap.push("GT6002");
         groceryKeyMap.push("GT6001");
    ...
    public String getNextGroceryId() {
        return groceryKeyMap.pop();
    }
   public String getNextScaleId() {
        return scaleKeyMap.pop();
    }
    ...
    public boolean isOpen() {
       // if (!this.isOpen) {
            ...
            if (terminalState != null && terminalState.getTimestamp("closedDate")==null) {
                this.isOpen = true;
            } else {
                this.isOpen = false;
            }
     ...
     */
    public static String GroceryItem = "GROCERY";
    public static String ScalItem = "SCALE";
    public List<GenericValue> lookupItem(String sku) throws GeneralException {
        if (sku.equals(GroceryItem)) {
            try {
                String grocerId = getNextGroceryId();
                Debug.logInfo("Name: " + sku + " grocerId: " + grocerId, module);
                if (grocerId != null) {
                    return ProductWorker.findProductsById(session.getDelegator(), grocerId, null);
                }
            } catch (Exception e) {
            }
            return new ArrayList<GenericValue>();
        } 
        else if (sku.equals(ScalItem)) {
            try {
                String scaleId = getNextScaleId();
                Debug.logInfo("Name: " + sku + " scaleId: " + scaleId, module);
                if (scaleId != null) {
                    return ProductWorker.findProductsById(session.getDelegator(), scaleId, null);
                }
            } catch (Exception e) {
            }
            return new ArrayList<GenericValue>();
    ...
    BigDecimal gstPercentage = new BigDecimal(0.1);

    public BigDecimal getTotalGST() {
        BigDecimal gstAmount = BigDecimal.ZERO;
        Iterator<ShoppingCartItem> pcmIter = cart.iterator();
        while (pcmIter.hasNext()) {
            ShoppingCartItem cartItem = pcmIter.next();
            if (cartItem.taxApplies()) {
                BigDecimal dspAmount = cartItem.getDisplayPrice();
                if (dspAmount != null) {
                    BigDecimal gstItemAmount = dspAmount.multiply(gstPercentage);
                    gstAmount = gstAmount.add(gstItemAmount);
                }
            }
        }
        // Debug.logInfo("Total Gst: " + gstAmount, module);
        return gstAmount;
    }

    public BigDecimal getTaxTotal() {
        return cart.getTotalSalesTax();//.add( getTotalGST());
    }
    ...
    public Map<String, Object> getItemInfo(int index) {
        ...
        // Debug.logInfo("Normal Price: " + price, module);
        if (price != null) {
            /*GenericValue productStore = ProductStoreWorker.getProductStore(this.productStoreId, session.getDelegator());
             Debug.logInfo("productStore.get(\"showPricesWithVatTax\"): " + productStore.get("showPricesWithVatTax"), module);
             if (UtilValidate.isNotEmpty(productStore) && "Y".equals(productStore.get("showPricesWithVatTax")) && item.taxApplies()) {
             price = price.add(price.multiply(new BigDecimal(0.1)));//grandTotal.subtract(this.getTotalSalesTax());
             Debug.logInfo("Gst Price: " + price, module);
             }*/
        } else {
            price = BigDecimal.ZERO;
        }
        BigDecimal displayPrice = item.getDisplayPrice();
        BigDecimal subTotal = price.multiply(item.getQuantity());
        itemInfo.put("basePrice", UtilFormatOut.formatPrice(price));
        itemInfo.put("subtotal", UtilFormatOut.formatPrice(subTotal));
        ...
        if (this.isAggregatedItem(item.getProductId())) {
            ...
            for (ConfigOption configoption : selected) {
                ...
                if (configoption.isSelected() && !configoption.isDefault()) {
                    ...
                    BigDecimal price = configoption.getOffsetPrice();
                    if (price != null) {
                        GenericValue productStore = ProductStoreWorker.getProductStore(this.productStoreId, session.getDelegator());
                        Debug.logInfo("productStore.get(\"showPricesWithVatTax\"): " + productStore.get("showPricesWithVatTax"), module);
                        if (UtilValidate.isNotEmpty(productStore) && "Y".equals(productStore.get("showPricesWithVatTax")) && item.taxApplies()) {
                            price = price.add(price.multiply(new BigDecimal(0.1)));//grandTotal.subtract(this.getTotalSalesTax());
                            Debug.logInfo("getItemConfigInfo Gst Price: " + price, module);
                        }
                    } else {
                        price = BigDecimal.ZERO;
                    }

                    itemInfo.put("configBasePrice", UtilFormatOut.formatPrice(price));
                    //itemInfo.put("isTaxable", item.taxApplies() ? "T" : " ");
                    list.add(itemInfo);
                }
            }
    ...
    public ShoppingCartItem addItem(String productId, BigDecimal quantity) throws CartItemModifyException, ItemNotFoundException {
        ...
        try {
            ...
            Debug.logInfo("product.getproductId: " + productId, module);
            Debug.logInfo("product.getString(\"amountRequired\"): " + product.getString("amountRequired"), module);
            if (UtilValidate.isNotEmpty(product) && "Y".equals(product.getString("amountRequired"))) {

                // print the receipt
               /* if (DeviceLoader.scale != null) {
                 try {
                 int weight[] = new int[1];
                 DeviceLoader.scale.readWeight(weight, 3000);
                 quantity = BigDecimal.valueOf(weight[0]);
                 //scaleCurrWeight.setText(String.valueOf(weight[0]));
                 //System.out.println("Read Weight Button pressed!\n");
                 } catch (JposException e) {
                 //handleJposException(e);
                 JOptionPane.showMessageDialog(null, "Failed to open \"" + DeviceLoader.scale.getDeviceName()
                 + "\"\nException: " + e.getMessage(), "Failed", JOptionPane.ERROR_MESSAGE);
                 System.err.println("Jpos exception " + e);
                 throw e;
                 }
                 } else {
                 JOptionPane.showMessageDialog(null, "Scale is not set", "Failed", JOptionPane.ERROR_MESSAGE);
                 }*/
                if (DeviceLoader.deviceScale != null) {
                    try {
                        quantity = BigDecimal.valueOf(DeviceLoader.deviceScale.readWeight());
                    } catch (ScaleException e) {
                        //handleJposException(e);
                        JOptionPane.showMessageDialog(null, "Failed to open \"" + DeviceLoader.deviceScale.toString()
                                + "\"\nException: " + e.getMessage(), "Failed", JOptionPane.ERROR_MESSAGE);
                        System.err.println("Jpos exception " + e);
                        throw e;
                    }
...
//else {
                //throw new CartItemModifyException("Scale is not opened");
    ...
    public void modifyConfig(String productId, ProductConfigWrapper pcw, String cartIndex)
        ...
        try {
            /*
             try {
             throw new CartItemModifyException("Button click");
             } catch (CartItemModifyException e) {
             trace("add item error", e);
    ...
    public void modifyPrice(String productId, BigDecimal price) {
        ...
        if (item != null) {
            ...
            GenericValue productStore = ProductStoreWorker.getProductStore(cart.getProductStoreId(), XuiContainer.getSession().getDelegator());
            if (UtilValidate.isNotEmpty(productStore) && "Y".equals(productStore.get("showPricesWithVatTax"))) {
                ...
                try {
                    totalPriceWithTaxMap = XuiContainer.getSession().getDispatcher().runSync("calcTaxForDisplay", UtilMisc.toMap("basePrice", totalPrice, "productId", productId, "productStoreId", cart.getProductStoreId()));
                    for (Map.Entry<String, Object> entryDept : totalPriceWithTaxMap.entrySet()) {
                    ...
                    Logger.getLogger(PosTransaction.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
    ...
    public ShoppingCartItem findShoppingCartItem(String productId) {
        trace("find Shopping Cart Item", productId);
        return cart.findCartItem(productId, null, null, null, BigDecimal.ZERO);
    }
    ...
    public boolean isDifferentPaymentMethodExists(String paymentMethodId) {

        List<ShoppingCart.CartPaymentInfo> listPayInfo = cart.getPaymentInfos(true, false, false);
        trace(" check payment method:: " + paymentMethodId);
        for (ShoppingCart.CartPaymentInfo payInfo : listPayInfo) {
            trace(" payment method:: " + payInfo.paymentMethodId);
            if (payInfo.paymentMethodId.equals(paymentMethodId) == false) {
                return true;
            }
        }
...
//        }
//        else{
//            output.print("Amount Owing: " + " " + UtilFormatOut.formatPrice(this.getTotalDue().negate()));            
//        }
    ...
    /*
     ...
     if (cart != null) {
     BigDecimal taxAmount = cart.getTotalSalesTax();//.add(getTotalGST());
     ...
     Journal.appendNode(taxLine, "td", "desc", "GST on Sales"UtilProperties.getMessage(resource, "PosSalesTax", locale));
     ...
     //su modify
     //            if(total!=null){
     //               total=total.subtract(taxAmount).setScale(scale, rounding);
     //            }
    ...
    public void appendItemDataModel(XModel model) {
        if (cart != null) {
            ...
            while (i.hasNext()) {
                ...
                BigDecimal quantity = item.getQuantity();
                BigDecimal displayPrice = item.getDisplayPrice();
                BigDecimal subTotal = displayPrice.multiply(quantity);
                BigDecimal adjustment = item.getOtherAdjustments();
    ...
    public void appendTotalDataModel(XModel model) {
        if (cart != null) {
            ...
            while (i.hasNext()) {
                ...
                grandTotal = grandTotal.add(item.getDisplayPrice().multiply(item.getQuantity()));
            }
            ...
            BigDecimal diff = grandTotal.subtract(total).abs();
            if (diff.compareTo(new BigDecimal(0.025)) > 0) {
                total = grandTotal;
            }
            ...
            Journal.appendNode(taxLine, "td", "desc", "GST Incl."/*UtilProperties.getMessage(resource, "PosSalesTax", locale)*/);
            Journal.appendNode(taxLine, "td", "qty", "");
            Journal.appendNode(taxLine, "td", "price", UtilFormatOut.formatPrice(taxAmount));
            Journal.appendNode(taxLine, "td", "index", "-1");
    ...
    public ArrayList<CustomerDisplayData> appendCustomerItemDataModel() {
        ...
        if (cart != null) {
            ...
            while (i.hasNext()) {
                ...
                data.sku = item.getProductId();
                data.desc = item.getName();
                data.qty = UtilFormatOut.formatQuantity(quantity);
                data.price = UtilFormatOut.formatPrice(subTotal);
                data.index = Integer.toString(cart.getItemIndex(item));
                data.unitPrice = UtilFormatOut.formatPrice(price);
                list.add(data);
                ...
                if (this.isAggregatedItem(item.getProductId())) {
                    ...
                    for (ConfigOption configoption : selected) {
                        if (configoption.isSelected()) {
                            data = new CustomerDisplayData();
                            data.sku = "";
                            data.desc = configoption.getDescription();
                            //data.qty = UtilFormatOut.formatQuantity(quantity);
                            data.price = UtilFormatOut.formatPrice(configoption.getPrice());
                            data.index = Integer.toString(cart.getItemIndex(item));
                            list.add(data);
...
//                    Journal.appendNode(promo, "td", "price", UtilFormatOut.formatPrice(adjustment));
                    ...
                    data = new CustomerDisplayData();
                    data.sku = "";
                    data.desc = UtilProperties.getMessage(resource, "PosItemDiscount", locale);
                    //data.qty = UtilFormatOut.formatQuantity(quantity);
                    data.price = UtilFormatOut.formatPrice(adjustment);
//                    data.index = Integer.toString(cart.getItemIndex(item));
                    list.add(data);
    ...
    public ArrayList<CustomerDisplayData> appendCustomerTotalDataModel() {
        ArrayList<CustomerDisplayData> list = new ArrayList<CustomerDisplayData>();
        ...
        if (cart != null) {
            ...
            for (GenericValue orderAdjustment : adjustments) {
                ...
                CustomerDisplayData data = new CustomerDisplayData();
                data.sku = "";
                data.desc = UtilProperties.getMessage(resource, "PosSalesDiscount", locale);

                if (UtilValidate.isNotEmpty(amount)) {
                    data.qty = "";
                    data.price = UtilFormatOut.formatPrice(amount);
                } else if (UtilValidate.isNotEmpty(sourcePercentage)) {
                    BigDecimal percentage = sourcePercentage.movePointLeft(2).negate(); // sourcePercentage is negative and must be show as a positive value (it's a discount not an amount)
                    data.qty = UtilFormatOut.formatPercentage(percentage);
                    amount = cart.getItemTotal().add(itemsAdjustmentsAmount).multiply(percentage); // itemsAdjustmentsAmount is negative
                    data.price = UtilFormatOut.formatPrice(amount.negate()); // amount must be shown as a negative value
                }
                data.index = "-1";
                list.add(data);
            }
            ...
            CustomerDisplayData data = new CustomerDisplayData();
            data.sku = "";
            data.desc = "GST on Sales ***********";
            data.qty = "";
            data.price = UtilFormatOut.formatPrice(taxAmount);
            data.index = "-1";
            list.add(data);
...
//            Journal.appendNode(totalLine, "td", "index", "-1");
            data = new CustomerDisplayData();
            data.sku = "";
            data.desc = UtilProperties.getMessage(resource, "PosGrandTotal", locale);
            data.qty = "";
            data.price = UtilFormatOut.formatPrice(total);
            data.index = "-1";
            list.add(data);
        }
        return list;
    ...
    public ArrayList<CustomerDisplayData> appendCustomerPaymentDataModel() {
        ArrayList<CustomerDisplayData> list = new ArrayList<CustomerDisplayData>();
        if (cart != null) {
            int paymentInfoSize = cart.selectedPayments();
            // Debug.logInfo("paymentInfoSize: " + paymentInfoSize, module);            
            for (int i = 0; i < paymentInfoSize; i++) {
                ShoppingCart.CartPaymentInfo inf = cart.getPaymentInfo(i);
                GenericValue paymentInfoObj = inf.getValueObject(session.getDelegator());
...
//                Journal.appendNode(paymentLine, "td", "index", Integer.toString(i));
                CustomerDisplayData data = new CustomerDisplayData();
                data.sku = "";
                data.desc = descString;
                data.qty = "-";
                data.price = UtilFormatOut.formatPrice(amount.negate());
                data.index = Integer.toString(i);
                list.add(data);
            }
        }

        // Debug.logInfo("list size(): " + list.size(), module);            
        return list;
    }

    public ArrayList<CustomerDisplayData> appendCustomerChangeDataModel() {
        ArrayList<CustomerDisplayData> list = new ArrayList<CustomerDisplayData>();
        if (cart != null) {
            BigDecimal changeDue = this.getTotalDue().negate();
            if (changeDue.compareTo(BigDecimal.ZERO) >= 0) {
...
//                Journal.appendNode(changeLine, "td", "price", UtilFormatOut.formatPrice(changeDue));
                ...
                data.desc = "Change";
                data.qty = "-";
                data.price = UtilFormatOut.formatPrice(changeDue);
//                data.index = Integer.toString(i);
                list.add(data);
    ...
    public void loadSale(PosScreen pos) {
        ...
        if (!shoppingLists.isEmpty()) {
            ...
            if (!salesMap.isEmpty()) {
                ...
                pos.showMessageDialog("dialog/error/nosales");
            }
        } else {
            pos.showMessageDialog("dialog/error/nosales");
        }
    ...
    public void saveOrder(String shoppingListName, PosScreen pos) {
        trace("Save an order");
        if (cart.size() == 0) {
            pos.showMessageDialog("dialog/error/exception", UtilProperties.getMessage("OrderErrorUiLabels", "OrderUnableToCreateNewShoppingList", locale));
            return;
        }
    ...
    public void saveSale(String shoppingListName, PosScreen pos) {
        ...
        if (!UtilValidate.isEmpty(shoppingListName)) {
            ...
            if (ServiceUtil.isError(newListResult)) {
                ...
                pos.showMessageDialog("dialog/error/exception", error);
                return;
            }
    ...
    public String editClientProfile(String name, String email, String phone, String card, PosScreen pos, String editType, String partyId) {
        ...
        if ("create".equals(editType)) {
            ...
            if (UtilValidate.isNotEmpty(email) && UtilValidate.isNotEmpty(phone)) {
                ...
                if (ServiceUtil.isError(svcRes)) {
                    pos.showMessageDialog("dialog/error/exceptionLargeSmallFont", ServiceUtil.getErrorMessage(svcRes)); // exceptionLargeSmallFont used to show duplicate key error message for card
                    return null;
                }
                ...
                if (ServiceUtil.isError(svcRes)) {
                    pos.showMessageDialog("dialog/error/exception", ServiceUtil.getErrorMessage(svcRes));
                    return result;
                }
                partyId = (String) svcRes.get("partyId");
            ...
            if (UtilValidate.isNotEmpty(phone)) {
                if (phone.length() < 5) {
                    pos.showMessageDialog("dialog/error/exception", UtilProperties.getMessage(PosTransaction.resource, "PosPhoneField5Required", locale));
                } else {
            ...
            if (!person.getString("lastName").equals(name)
                ...
                if (ServiceUtil.isError(svcRes)) {
                    pos.showMessageDialog("dialog/error/exceptionLargeSmallFont", ServiceUtil.getErrorMessage(svcRes));
                    return null;
                }
            }
            ...
            pos.showMessageDialog("dialog/error/exception", UtilProperties.getMessage(resource, "PosNoClientProfile", locale));
            return null;
        }
        return null;
    }
