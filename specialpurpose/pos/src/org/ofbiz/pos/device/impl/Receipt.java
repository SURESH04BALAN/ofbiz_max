...
public class Receipt extends GenericDevice implements DialogCallback {
    ...
    public static String Customer_Receipt_File_Name = "custreceipt_windows.txt";
    public static String Totals_Receipt_File_Name = "totals_windows.txt";
    ...
    private synchronized String[] readCustomerTemplate() {
        if (this.custReceiptTmpl == null) {
            ...
            this.readTemplate(custReceiptTmpl, Customer_Receipt_File_Name, 0);
        }
    ...
    private Map<String, Object> makeCodeExpandMap(PosTransaction trans, int type) {
        ...
        expandMap.put("dateStamp", trans.getDate());
    ...
    private boolean checkState(POSPrinter printer) throws JposException {
        if (printer.getCoverOpen() == true) {
            ...
            PosScreen.currentScreen.showDialog("main/dialog/error/printernotready");
            return false;
        }
