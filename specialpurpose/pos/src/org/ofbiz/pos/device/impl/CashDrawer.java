...
//import com.starmicronics.starjavapos;
...
public class CashDrawer extends GenericDevice implements Runnable, DialogCallback {
    ...
    public CashDrawer(String deviceName, int timeout) {
        ...
        //com.starmicronics.starjavapos.CashDrawerESCPOSService
    }
    ...
    public void openDrawer() {
        ...
        try {
            ...
            this.comError++;
            PosScreen.currentScreen.showMessageDialog("dialog/error/drawererror", e.getMessage());
        }
    }
