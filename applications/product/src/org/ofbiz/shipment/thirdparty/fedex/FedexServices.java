    ...
    */
    ...
    public static Map<String, Object> fedexShipRequest(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            // Determine the currency by trying the shipmentRouteSegment, then the Shipment, then the framework's default currency, and finally default to AUD
            ...
            if (UtilValidate.isNotEmpty(shipmentRouteSegment.getString("currencyUomId"))) {
                ...
                currencyCode = EntityUtilProperties.getPropertyValue("general.properties", "currency.uom.id.default", "AUD", delegator);
            }
