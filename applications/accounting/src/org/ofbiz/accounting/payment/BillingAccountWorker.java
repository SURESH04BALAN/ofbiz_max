...
public class BillingAccountWorker {
  ...
  Debug.logInfo("billingAccountId : " + billingAccountId, module);
        BigDecimal balance = ZERO;
        BigDecimal accountLimit = getAccountLimit(billingAccount);
        Debug.logInfo("accountLimit : " + accountLimit, module);
        balance = balance.add(accountLimit);
                Debug.logInfo("balance : " + balance, module);
        ...
        EntityConditionList<EntityExpr> whereConditions = EntityCondition.makeCondition(UtilMisc.toList(
                ...
                EntityCondition.makeCondition("statusId", EntityOperator.NOT_IN, UtilMisc.toList("ORDER_CANCELLED", "ORDER_REJECTED" , "ORDER_RECEIVED", "ORDER_SETTLED")),
                EntityCondition.makeCondition("preferenceStatusId", EntityOperator.NOT_IN, UtilMisc.toList("PAYMENT_SETTLED", "PAYMENT_DECLINED", "PAYMENT_CANCELLED")) // PAYMENT_NOT_AUTH
           ), EntityOperator.AND);
        ...
        for (Iterator<GenericValue> oppsi = orderPaymentPreferenceSums.iterator(); oppsi.hasNext();) {
            ...
            Debug.logInfo("maxAmount : " + maxAmount, module);
        ...
        Debug.logInfo("paymentAppls size: " + paymentAppls.size(), module);        
        ...
        for (Iterator<GenericValue> pAi = paymentAppls.iterator(); pAi.hasNext();) {
            ...
            if (paymentAppl.getString("invoiceId") != null) {
                         Debug.logInfo("paymentAppl.getString(invoiceId) : " + paymentAppl.getString("invoiceId"), module);
                BigDecimal amountApplied = paymentAppl.getBigDecimal("amountApplied");
                         Debug.logInfo("amountApplied : " + amountApplied, module);
