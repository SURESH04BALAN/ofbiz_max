...
public class ShoppingCartItem implements java.io.Serializable {
    ...
    */
    ...
    protected boolean isInventoryAvailableOrNotRequired(BigDecimal quantity, String productStoreId, LocalDispatcher dispatcher) throws CartItemModifyException {
        ...
        try {
            Debug.logWarning("Check inventory productStoreId: " + productStoreId + ", productId: " + productId +
                    ", product: " + this.getProduct() + " quantity: " + quantity, module);
        ...
        if (_product != null && isModifiedPrice == false) {
            try {
                ...
                if (cart.getOrderType().equals("PURCHASE_ORDER")) {
                    ...
                    Debug.logInfo("cart.getCurrency(): " + cart.getCurrency(), module);
...
for (Map.Entry<String, Object> entryDept : priceResult.entrySet()) {
