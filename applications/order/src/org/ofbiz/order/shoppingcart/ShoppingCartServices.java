...
public class ShoppingCartServices {
    ...
    public static Map<String, Object>loadCartFromOrder(DispatchContext dctx, Map<String, Object> context) {
        ...
        Debug.logError("shopingCart facility Id: " + orderHeader.getString("originFacilityId"), module);                 
        try {
        ...
        if (UtilValidate.isNotEmpty(orderItems)) {
            for (GenericValue item : orderItems) {
                ...
                try {
                    Debug.logInfo("shopping cart service productId: " + productId, module);
    ...
    public static Map<String, Object>loadCartFromShoppingList(DispatchContext dctx, Map<String, Object> context) {
        ...
        // If we still have no currency, use the default from general.properties.  Failing that, use AUD
        if (currency == null) {
                currency = UtilProperties.getPropertyValue("general", "currency.uom.id.default", "AUD");
        }
